...
Content
Overview                                                                   A        Stock withdrawal without order .......................... C-80
                                                                                  Info page ............................................................... C-82
Tutorial .................................................................. A-9     Missing prices .................................................... C-83
Documentation ...................................................... A-11           Inventory ............................................................ C-84
Basics ................................................................... A-12       Inventory of a box stock ................................... C-86
 A+W Smart Companion - Basic License ............ A-12                                Inventory of a warehouse ................................. C-88
 A+W Smart Companion - Production ................. A-12                              Checklist .......................................................... C-91
 A+W Smart Companion – Stock ........................ A-12                          Editing a box ...................................................... C-94
Operation ............................................................. A-13        Print again ........................................................ C-100
 Module selection ................................................ A-13           Settings ............................................................... C-104
 Hardware mode ................................................. A-13
...
Booking goods receipt .......................................... C-68
 Override stock location ...................................... C-72
  Assign registration point .................................. C-73
Booking stock movements ................................... C-75
Booking stock withdrawals ................................... C-77
 Stock withdrawal with order ............................... C-77
...
                                                                                                                          Tutorial
       ...
       Booking stock withdrawals .................................................................................... C-77
         Stock withdrawal with order ............................................................................... C-77
         Stock withdrawal without order .......................................................................... C-80
       Info page ............................................................................................................... C-82
         Missing prices .................................................................................................... C-83
         Inventory ............................................................................................................ C-84
            Inventory of a box stock ................................................................................. C-86
            Inventory of a warehouse ............................................................................... C-88
            Checklist ........................................................................................................ C-91
         Editing a box ...................................................................................................... C-94
         Print again ....................................................................................................... C-100
       Settings ............................................................................................................... C-104
...
Booking goods receipt                                                                          Tutorial
                        ...
                        completely digitalized, both for A+W Enterprise and for A+W Produktion. Book
...
Booking goods receipt                                                                             Tutorial
                        ...
                        tion. A+W Produktion and work preparation are informed automatically. You
                        can initiate label printing (optional) and specify rack (also third-party). This
                        data is stored in A+W Enterprise and in the A+W Produktion PDC.
                        ...
                        This element represents a PO for a box stock.

                           Book boxes only completely
                           Goods receipts for boxes can only be booked completely. That is, the box
                           quantity delivered must match the box quantity ordered. No partial deliver-
                           ies can be booked in this area!
...
Tutorial                                                                       Booking goods receipt
                     ...
                     sions, storage location, and variants. A variant is, for example, a packaging
                     unit, a size, a color, etc.
...
Tutorial                                                                      Booking goods receipt
                     ...
                     Produktion. If there are a lot of registration points at your company and the
...
Tutorial                                                                  Booking stock movements
                     ...
                     Enterprise.
                     Select the required storage location from the combo box.
                     ...
                     rently in the selected storage location.
                        ...
                        of the line. Then the area for scanning opens.
...
Info page                                                                           Tutorial
            ...
            The inventory is done on the stock location level and is started in A+W Enter-
            prise. Stock is not blocked during inventory. This means that during inventory,
            you can keep working normally. You can book goods receipts and withdrawals
            and make rebookings.
...
Tutorial                                                                                 Info page
                     ...
                     In the Inventory area, a distinction is made between the two following loca-
                     tions:
                     •   Box stock
                     •   Warehouse
...
Info page                                                                          Tutorial
            ...
            If you are working at a company with one or several box stocks, you can simply
            scan the box(es) in question for the inventory.
            Select the appropriate box stock from the Inventory stock combo box.




            Then if you touch Start, the following view appears:




            You can now scan the box barcode or enter it via the keyboard. Scanned box-
            es will be displayed in the list below:
...
Tutorial                                                                                Info page
                     ...
                     Using the individual symbols, you can see the status of the scanning:

                     Icon        Explanation

                                 The box was scanned successfully.


                                 An error occurred during scanning.


                                 This box was scanned twice.


                     Tab. 1      Explanation of symbols when scanning boxes

                        Scanning boxes
                        When you scan the boxes during an inventory, as many boxes as you wish
                        can be scanned. The scanned boxes are added to the inventory after scan-
                        ning.
...
Info page                                                                                Tutorial
            ...
            The inventory of a warehouse differs from the inventory of a box stock in that
            various inputs (e.g., article name, variant, etc.) are required here.
            For a detailed description of this inventory, see the steps below.
            ...
            2 Select the article that you would like to count in the Article name field. If the
              appropriate EAN barcodes are stored in A+W Enterprise, you can also
              scan the article.
...
Info page                                                                         Tutorial
            ...
            ed the article on 12/01/2020 at 2:10 AM. The green checkmark indicates that
            the variant of the article was already counted.
...
A+W Smart Companion Stock                                                                     C-101
Info page                                                                            Tutorial
            ...
            If you touch the icon, printing will start automatically.
               ...
               In the view, the box symbol is on the right side. If you would like to reprint
               labels for complete boxes, you can touch this box symbol. Then enter the
               box number or scan it.




C-102                                                         A+W Smart Companion Stock
Tutorial                                                     Info page
...
A+W Smart Companion Stock                                      C-103
Settings                                                                        Tutorial
...
C-104                                                       A+W Smart Companion Stock
D   A+W Smart Companion
    Index
A                                        – Settings page B-27
Action in Stock module                   – Status page B-26
– Editing a box C-94                     Menu bar in Stock module C-66
– Inventory C-84                         – Goods receipt C-66
– Reprint C-100                          – Info page C-66
Actions in Production module             – Missing prices C-83
– Actual rack weight B-53                – Settings page C-67
– Rack inventory B-54                    – Stock movement C-66
– Registration point status B-50, B-51   – Stock withdrawal C-66
Assign registration point C-73           Message
                                         – Green A-16
                                         – Red A-16
B
                                         Messages and notices A-15
...
Filter
                                         – Red dot A-15
– Alphabetical search A-18
                                         – Yellow dot A-15
– Numeric search A-18
Filter function A-17
                                         O
                                         Override stock location   C-72
G
Goods receipt
...
Hardware mode A-13
– Smartphone A-14                        S
– Zebra scanner A-14                     Scan mode
                                         – Continuous B-28
                                         – Individual B-28
I
                                         Settings B-57
Info page in Production module B-39
                                         – Adjust configuration B-58
– Order location B-48
                                         – App selection B-58
– Orders B-43
                                         – Download master data B-57
– Racks B-40
                                         – Hardware mode B-59
Info page in Stock module C-82
                                         – Help B-58
                                         – Imperial system B-59
L                                        – Information B-58
Login on                                 – Language B-57
– Stock module C-65                      – Log B-57
Login on Production module   B-23        – Log out B-59
                                         Settings in Stock module C-104
M                                        Status page B-35
Machine status B-34                      Stock module A-12
Menu bar in Production module    B-26    – Login C-65
– Breakage page B-26                     Stock order with missing price C-70
– Info page B-26                         Stock withdrawal with order C-77
– Scan B-26                              Stock withdrawal without order C-80



D-106                                                              A+W Smart Companion

