...
09.08.2021                       EN-INST-A+W Clarity SmartFactory.docx                  1
Content
   ...
   Beta - A+W Clarity Smart Factory - Multistep Automated Production ........ 1

   1         Requirements ................................................................................. 4
   1.1       Informix ................................................................................................................4
   1.2       A+W Production ...................................................................................................4
   1.3       A+W StockService .................................................................................................5
   1.4       A+W OptimizationService for furnace optimization .............................................6
   ...
   2.3       MAPS service ........................................................................................................8
   2.4       Clarity Suite...........................................................................................................8
   2.5       Shopfloor Clients ..................................................................................................9
   2.5.1     Dynopt Filler Client .............................................................................................10
   2.5.2     HEGLA Sortjet Client ...........................................................................................12
   2.5.3     North-Glass furnace client ..................................................................................15
   2.5.4     Sample XML file ..................................................................................................17
   2.6       Panorama Clients ................................................................................................18
   2.7       Dynopt configuration Xopton.cfg .......................................................................18
   2.7.1     Section [CutGo]...................................................................................................18

   3         The ticket system in the Smart Factory ......................................... 19
   3.1       The ticket status .................................................................................................19
   3.2       The lite status .....................................................................................................20
   3.3       The validation status...........................................................................................21
   3.4       ValidateAndExecuteSheetTask ...........................................................................22
   3.5       Ticket flow in production ....................................................................................24

   4         HEGLA Sortjet ............................................................................... 25
   4.1       Reservations for transport in and out .................................................................25


09.08.2021                                 EN-INST-A+W Clarity SmartFactory.docx                                                     2
   4.2       Moving lites into and out of the SortJet .............................................................25

   5         Control of North-Glass furnace ..................................................... 27
   5.1       NorthGlass communication ................................................................................27
   5.2       Furnace optimization ..........................................................................................27
   5.3       Moving furnace beds in and out of the furnace..................................................28
   5.4       Determining the size of the furnace bed dynamically.........................................30

   6         Assembling units with the SmartFactory....................................... 32

   7         Diving through the SmartFactory .................................................. 33

   8         Breakage in the SmartFactory ....................................................... 34
   8.1       Validation of the remake pool ............................................................................34

   9         Structure of the timeline .............................................................. 36

   10        User interface ............................................................................... 37
   10.1      Call dialogs ..........................................................................................................37
   10.1.1    Status descriptions .............................................................................................37
   10.1.2    General batch information .................................................................................37
   10.1.3    Assembly ............................................................................................................38
   10.1.4    Hegla A-rack wall ................................................................................................41
   10.2      Supply dialogs .....................................................................................................42
   10.2.1    Supply SortJet 1/2 ...............................................................................................42

   11        PDC connection to the SmartFactory ............................................ 44

   12        Table of figures ............................................................................. 45




09.08.2021                                EN-INST-A+W Clarity SmartFactory.docx                                                     3
1 Requirements
A+W Clarity SmartFactory is a multi-level automated production system (MAPS). It requires a run-
capable A+W Production SingleSite environment.
...
the A+W production (EnableInsertCursors=0). For the AWSOA database under Informix, this also in
the ODBC settings.
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                           4
1.3 A+W StockService
Each sorter that should be controlled via the MAPS system (currently HEGLA Sortjets are supported)
has to be mapped in the SortingService (function of the A+W StockService). This way, MAPS saves the
state of the sorter; this is required, for example, in order to synchronize with the sorter.
...
buffers in the StockService are unique. This means that the second Sortjet cannot have the ID 1 for its
first physical buffer. In this case, it could be number 3. The implementation between ID in the
StockService and that of HEGGLA for the control of the Sortjet is done in the MAPS Sortjet client.




09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                               5
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                              6
2 Installation
An installation consists of several components: the MAPS service, the MAPS navigator, several MAPS
ShopFloor clients, and possibly several additional clients, which are integrated in Panorama scripts,
for example.
...
in the PDC master data. MAPS locations that are not sorters or outputs also require a correspodning
MZO machine ID.
...
09.08.2021                        EN-INST-A+W Clarity SmartFactory.docx                             7
    •   0 = None
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                               8
...
controlled in the master data via the field Maps_ClientConfigurations.ControlTyeName.
...
09.08.2021                                 EN-INST-A+W Clarity SmartFactory.docx                          9
...
The Dynopt Filler client needs an XML file for the configuration:
 <DynOptFiller>
     • DefectBarcode
         ...
         are made for lites that cannot be reported broken in the SmartFactory during validation of
         the SmartFactory with the breakage pool.
     • NumberOfOutputLines
...
09.08.2021                              EN-INST-A+W Clarity SmartFactory.docx                   10
               DynoptIGLinie number from the Xopton.cfg
           ...
           o < PrimaryBufferSegment >
               Primary buffer setment for the output. The selection of the primary buffer segment
           ...
           o < AvoidBufferSegments ></AvoidBufferSegments >
               Buffer setments to be avoided for this output. Here the buffer segments are listed,
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                            11
        <OutputLine Id="2" DyoptIGLine="2" FinalLocation ="1319" PrimaryBufferSegment="1"
                ...
                <BufferSegments>3</BufferSegments>
                <BufferSegments>2</BufferSegments>
                                <BufferSegments>4</BufferSegments><BufferSegments>4</BufferSegments>
...
The client also needs another XML file for teh configuration in which the connection information for
HEGLA MMI is set.
Tag <Sorter>:
    • <Ip>
    ...
    •   <Station>
        ...
        another. This switch has the following attributes:
             ...
             o   Type (InputStation; OutputStation; PhysicalStorage; VirtualStorage)
                 The type of station.
             o   LocationId
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                          12
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                             13
                     maximum of lites is ignored. If you only want to have one lite per slot, use the "single"
             ...
             o       AssemblyStation (Optional, True or False; default=False)
                     This switch affects the content of the GetSheetData telegram of HEGLA. If the value
...
09.08.2021                              EN-INST-A+W Clarity SmartFactory.docx                              14
                         SheetsCount - (int) the number of lites in SJ1 for the output
                      ...
                      The SJ client determines the number of lite N in the Sortjet for the output and
                      compares this with the SheetsCount from the configuration. Among all
                      SheetsCount <N the largest value of the SheetsCount is selected and the
                      corresponding factor is used as output factor.
...
previously the lites have to be reseved there for a sorter after the furnace.
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                               15
    •   <InputSorterId>
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                              16
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                            17
...
09.08.2021                        EN-INST-A+W Clarity SmartFactory.docx                            18
...
09.08.2021                           EN-INST-A+W Clarity SmartFactory.docx                            19
    •   80 = Finished
...
applies for the whole lite, and thus to all tickets of the lite:
    ...
    •   80 = Finished
        The lite is finished and will no longer return to the MAPS system



09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                    20
...
09.08.2021                           EN-INST-A+W Clarity SmartFactory.docx                                21
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                 22
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                   23
...
If a lite from the SmartFactory is ejected via an UNLOAD station and it should later be put into the
SmartFactory via a SUPPLY station, this coupling does not apply between the two tickets of the two
sections. If a client ejects a lite, it has to inform the SmartFactory of this(MAPS Interface ProgressLeft).
In this case the ticket is set to Finished, the successor (SUPPLY) to TreatmentPossible.




09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                24
4 HEGLA Sortjet
...
If the connection to HEGLA is re-established (e.g. due to the restart of cour client), they synchronize
...
Regardless of this, the client does not mix any SmartFactory groups and no lites that come from
...
several slots.
If a lite moves into the Sorjet, the same message (GlassPosition telegram) is sent, the station is the
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                               25
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                            26
5 Control of North-Glass furnace
For the furnace activation, divided into 4 function blocks. These can be obtained in a Maps ShopFloor
...
09.08.2021                                 EN-INST-A+W Clarity SmartFactory.docx                     27
...
09.08.2021                                EN-INST-A+W Clarity SmartFactory.docx                       28
...
09.08.2021                                EN-INST-A+W Clarity SmartFactory.docx                      29
...
09.08.2021                                EN-INST-A+W Clarity SmartFactory.docx                     30
...
09.08.2021                              EN-INST-A+W Clarity SmartFactory.docx                      31
...
The units are produced in the sequence from the detailed scheduling; in the SmartFactory, this is the
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                              32
...
More relevant in the SmartFactory are lites that leave the SmartFactory in order to be processed
outside of the SmartFactory and then inserted back into the SmartFactory.
Example: We have filled a sorter from cutting and from it, a furnace is fed. Now lites are in the sorter,
which receive a processing that is done outside of the SmartFactory before the hardening. Thus the
...
So that the SmartFactory can distinguish the sections of a lite, the ticket chain is subdivided into partial
sections. The boundary of a segment is always a supply input into the SmartFactory. As soon as this
limit has been passed, the lite is in the new section.
...
With the transfer from the SmartFactory via an unload ticket in the SmartFactory via a supply ticket,
the client has to communicate at the unload of the SmartFactory that it has now "let the lite go." If
this happens, the status of the supply ticket is set to TreatmentPossible (20) and the current section
is reduced by one.
If the sorter client now asks the SmartFactory for this lite, then it receives the data of the ticket of the
current section.




09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                33
8 Breakage in the SmartFactory
Breaks in the SmartFactory have to be reported to the A+W Production PDC by the triggering client if
they should go into the breakage pool there. The SmartFactory itself does not do this automaticlaly.
The ShopFloor clients have a connection to the PDC and book breakage accordingly.

If a breakage message is triggered in the SmartFactory, the tickets have to be cleaned up. The
...
85 or 93.
So that the client responsible for cutting the remakr knows whether a remake is OK or not, it has to
...
It can happen that remaks try to cut and this is not possible in the SmartFactory. If this happens, the
remakes are not cut, they disappear or the system stops.. There are different causes for this problem.
One of the causes is that a lite was reported broken outside of the SmartFactory, but the SmartFactory
still has access to this lite. The lite might be still being processed by a machine or be in a SortJet. The
SmartFactory cannot know where the lite actually is if nobody tells it this. It can happen that a lite is
missing and you don't know where it is and it has simply been reported broken. Now, according to
the SmartFactory, it is still in a SortJet. Then you have to check whether this is really the case and if
so, either ignore the break and continue producing the lite or remove the lite and then report it
broken to the SmartFactory. If the lite is still supposedly being processed on a machine, then you also
have to check there whether this is the case. If there was a machine breakdown and the lite was
simply removed from the machine without telling the SmartFactory about this, then the message has
to be repeated.

So that these problematic cases are detected, lites that are in the breakage pool should not simply be
re-optimized. Beforehand, there should be a validation by the SmartFactory. This is currently done
...
that the lite has no relevance for the Smart factory; that the lite can be re-cut in the SmartFactory; or
that it cannot be re-cut.
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                               34
...
unusuably that the time stamp in the database deviates from the own time stamp and 'someone has
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                             35
...
09.08.2021                        EN-INST-A+W Clarity SmartFactory.docx                            36
10 User interface
10.1 Call dialogs
The call dialogs are opened via the Production Terminal on the stations in question:
If no data can be called up, you will see a message:
...
In the lower left corner of the dialog, there is a legend that explains the currently displayed
colors:
 ...
 Complete (without                All missing lites are remakes
 remakes)
 Not complete                     At least one non-remake lite is missing
 Remake                           Part of the batch was called up and there is at least one remake in
                                  the lites yet to be called up
...
09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                              37
10.1.3 Assembly
In the overview, the available batches are displayed sorted in ascending order by time
stamp:
10.1.3.1 LAMI


The data corresponds to the information described in 0.


10.1.3.2 BSG TPS


The following data is displayed next to the information described in 0:
 Column         Description
 Primer         Primer: at least one lite in the batch receives a fire protection coating
                No Primer: none of the lites in the batch is coated
 Filled         Automatic: for all units included in the batch, the filled corner is set automatically
 corner         Manual: for at least one unit in the batch, the filled corner has to be set manually




09.08.2021                         EN-INST-A+W Clarity SmartFactory.docx                                 38
10.1.3.3 Cancel
By default, batches with canceled lites/units are not displayed in Production Terminal or
called up via the call dialog. Such lites can be recognized because after the call, they are
still on the list and have lites in the buffer:
...
09.08.2021                        EN-INST-A+W Clarity SmartFactory.docx                          39
The lites can be moved from the buffer with "Produce" and have to be removed manually after that.




09.08.2021                       EN-INST-A+W Clarity SmartFactory.docx                         40
...
09.08.2021                      EN-INST-A+W Clarity SmartFactory.docx     41
10.2 Supply dialogs
...
Only batches with the status "not reserved" can be transferred to the Maps service with a click on
"set selected group". The dialog is then closed and can be opened again to check the status again.
The status of the batch then changes to "Reservation running".
A successfully reserved batch receives the status "reserved".




09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                              42
...
09.08.2021                        EN-INST-A+W Clarity SmartFactory.docx                       43
11 PDC connection to the SmartFactory
There it not a SmartFactory client at every point. If at such a point the SmartFactory needs information
about the progress, this can be done with the PDC in A+W Production.

Prerequisite for this is a ticket in this place. A registration point can be assigned an agent. If a lite is
booked to this registration point via the PDC, then the SmartFactory will set the associated ticket to
the ticket status produced if the status is less than and the lite is in the SmartFactory (not broken or
outside it).

The registration point has to be entered in the MAPS_Agents.RegistartionPointProduced field and
has to be greater than 0 in order to activate the function. This function may not be activated on an
agent that depends directly on the automation and has a client that controls it. If this happens
nevertheless, chaos may arise in the automation due to the PDC messages.

The PDC messages can be issued by all common tools; the booking service sends all messages to the
SmartFactory, which then decides whether or not the message can be ignored. If the SmartFactory
...
09.08.2021                          EN-INST-A+W Clarity SmartFactory.docx                                44
12 Table of figures
Figure 1-1 Informix configuration .......................................................................................................... 4
Figure 2-1 Configuration Settings.xml for Clarity Suite .......................................................................... 9
Figure 2-2 Quick-Edit mode in DOS box ............................................................................................... 10
Figure 3-1 Lite movement in MAPS ...................................................................................................... 22
Figure 5-1 Starting furnace optimization ............................................................................................. 27
Figure 5-2 Result of a furnace optimization in the PatternViewer ...................................................... 28
Figure 5-3 ShopFloor client in front of the furnace without PatternViewer........................................ 29
Figure 5-4 ShopFloor Client in front of the furnace with PatternViewer ............................................. 29
Figure 5-5 PatternViewer in front of the furnace ................................................................................ 30
Figure 5-6 Glass article master data for managing furnace beds ........................................................ 30
Figure 5-7 Stock dimension master data for managing furnace beds ................................................. 31
Figure 9-1 Time horizon ....................................................................................................................... 36




09.08.2021                                        EN-INST-A+W Clarity SmartFactory.docx                                                        45

