---
title: "EN FUNC A+W Enterprise EDI Export"
category: "functional_descriptions"
product: "A+W Enterprise EDI Export"
doc_type: "Functional Description"
language: "EN"
tags: ["FUNC", "A+W Enterprise EDI Export"]
version: "1.0"
last_updated: "2025-12-10"
description: "Functional Description   A+W – Enterprise Export in the A+W standard format                                    english 1. Contents 1.   Contents                                                               3 2.   Notes on this Document                                                 4      2.1. Trademarks                                                        4      2.2. Copyrights                                                        4      2.3. Exclusion of liability"
source_file: "EN-FUNC-A+W Enterprise EDI Export.pdf"
---


# EN FUNC A+W Enterprise EDI Export

     Functional Description


A+W – Enterprise
Export in the A+W standard format
...
A+W Software GmbH                  EN-FUNC-A+W Enterprise EDI Export.docx       3
...
A+W Software GmbH              EN-FUNC-A+W Enterprise EDI Export.docx                                 4
...
3.2. Description
With appropriate configuration, existing POs can be exported in a file in the A+W standard
format. To learn which data records are exported and how the individual fields are filled, see the
interface description "EN-A+W EDI Import.pdf" section "A+W Enterprise Export-specific field
notes" and the configuration instruction "EN-CONFIG-A+W Enterprise EDI.pdf" section "PO
export/A+W EDI Export".
...
3.4. List of functions
    ...
    •   Record types that are currently written
            o   FH – File header record
            o   K1 – Header record general
            o   K2 – Header record customer address
            o   K3 – Header records delivery address
            o   P1 – Item
            o   P2 – Item
            o   P3 – Item


A+W Software GmbH              EN-FUNC-A+W Enterprise EDI Export.docx                                5
            o     BC - Barcode
            o     S1 – BOM
            o     B1 – Processing parameters
            o     C1 – Muntin record
            o     CA – Muntin record asymmetrical
            o     M1 – Shape record
            o     T1 – Text record item
            o     T2 – Text record document


3.5. Restrictions
The export writes the data records to the interface file according to the specification. However,
attention must be paid that the import of this file cannot be done 1:1 in all A+W products. In
some cases, the functional scope of the export is greater than the import of the individual
modules.
These restrictions affect:
    a) Only POs are exported
    b) Not all BOM elements are exported as S1 record:
        •   Glass: For multiple glasses, the glass of the first BOM level is always exported. If the
            first BOM level is a stock size (e.g. LAMI), then the 2nd BOM level is exported.
        ...
        •   Shapes: The shape S1 record is not always absolutely necessary. Frequently a M1
            record is sufficiently. Therefore, the S1 record for shapes is only exported if it was
            configured via the special shape S1 record stored procedure (see "EN-CONFIG-A+W
            Enterprise EDI.pdf")
...
A+W Software GmbH                EN-FUNC-A+W Enterprise EDI Export.docx                                6
         •   Muntins
         •   Processings
         •   Accessory
         •   Shape
         since this information is not available. If a storage of this information is absolutely
         necessary, this must be agreed upon with A+W before start-up.
    d) Foils can be exported but not imported into A+W Enterprise.
    e) Processings and glass exchange on deeper BOM levels are not imported in A+W
       Enterprise.
    ...
    h) Not all A+W processing types supported in A+W Enterprise are exported. The supported
       A+W processing types are documented in the interface description "EN-A+W EDI Import".
       Furthermore, not all exported A+W processing types are imported. The supported A+W
       processing types in the import are documented in the interface documentation "EN-A+W
       EDI Import".
Generally, exports for A+W Business must be tested in advance on a case by case basis since the
BOM requirements can differ significantly.
...
A+W Software GmbH                EN-FUNC-A+W Enterprise EDI Export.docx                            7
4. Contact Address
A+W Software GmbH
...
A+W Software GmbH           EN-FUNC-A+W Enterprise EDI Export.docx   8

