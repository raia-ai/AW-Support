---
title: "EN CONFIG A+W Enterprise Production Interface"
category: "configuration"
product: "A+W Enterprise Production Interface"
doc_type: "Configuration"
language: "EN"
tags: ["CONFIG", "A+W Enterprise Production Interface"]
version: "1.0"
last_updated: "2025-12-10"
description: "Configuration Instructions   A+W Enterprise 6 Production Interface                                           english                                   - -INTERNAL- Change history           Date        Author   Remarks                                                 Version                              #314985: Ignore kmodparam.refflag for whole glass         2013-03-14 PG        systems. New section „Ganzglasanlagen und               2012.1_13                              Modelldaten“"
source_file: "EN-CONFIG-A+W Enterprise Production Interface.pdf"
---
...
Change history
        ...
        2013-08-22 PG                                                                2012.1_9
                             ...
                             #267331: Additional motif parameter for surface
        ...
        2013-08-01 PG                                                                2012.1_8
                             ...
                             (steps/back cuts) can also be transferred if variable
...
A+W Software GmbH   EN-CONFIG-A+W Enterprise Production Interface.docx                     2
        Date        Author   Remarks                                               Version
        ...
        2013-04-10 PG        Bearbeitungstyp-Informationen“: Processing            2012.1_5
                             ...
                             Declaration of performance number was transferred
        2013-03-22 PG                                                              2012.1_4
                             as item text (due to AWDesk 274142)
...
A+W Software GmbH   EN-CONFIG-A+W Enterprise Production Interface.docx                      3
        Date        Author   Remarks                                               Version
                             Restructuring of the section "Customized
        2021-11-26 SVH
                             information"
                             Addition in the "Weight of main and sub parts"
        2022-02-09 SVH
                             section
        2022-07-20 SVH       System diagram
                             Adjustment of the chapter division
        2022-11-02 SVH       "Elements information" and "Processing information"
                             each have their own subchapter (level 2).
        2022-11-10 RS        Reservation resolution with XTV report
        2023-05-05 SVH       Cost calculation + reservation - [AW-126899]
                             [AW-142005] – Logical and physical machine in the
        2023-09-13 SVH
                             cost calculation
                             [AW-159250] – Logic
        2023-10-17 SVH
                             ORDERXML_PROCPOSTDEF_LEVELDOWN_MODE
        2024-07-22 SVH       Docu ORDERXML_POSTPROCTHERMAL_ON_TVG




A+W Software GmbH   EN-CONFIG-A+W Enterprise Production Interface.docx                   4
Content

1.   System diagram                                                                      9
2.   Transfer to OrderXML                                                               10
     2.1. General Information                                                           10
                  Amendments compared to the previous version                           10
                  Information about previous versions of A+W Enterprise OrderXML 6      11
     2.2. Process Overview                                                              11
                  In ALCIB                                                              11
                  Windows Service                                                       12
                  Details                                                               12
     2.3. Installation and configuration                                                19
                  Configuring the process                                               19
                  Fileless transfer via AWSOA Planning Import Service                   22
                  Starting the process                                                  22
                  Updating to a higher version                                          22
                  Tracing                                                               23
                  Activation in ALCIB                                                   25
                  Technical data                                                        27
     2.4. Environment variables                                                         28
                  ORDERXML_NOSTOCKPLATES                                                28
                  ORDERXML_PROCPOSTDEF_LEVELDOWN                                        28
                  ORDERXML_PROCPOSTDEF_LEVELDOWN_MODE                                   28
                  ORDERXML_ENDCUSTOMER_DETAILS                                          28
                  ORDERXML_POSTPROCTHERMAL_ON_TVG                                       29
     2.5. General information in the OrderXML                                           29
                  How to read the documentation text file                               30
                  OrderXML files                                                        30
                  ALCIB Environmentswitch                                               36
                  Item split                                                            42
                  Cancellation                                                          43
                  References in reports                                                 44
                  OrderXML files for purchase orders                                    45
                  OrderXML transfer just for production cost calculation                47
                  Items with supply type "none" in the OrderXML interface               48
                  End customer information                                              49
                  Automatic creation of rack groups and additional parameters for PMO   50
     2.6. Elements information in OrderXML                                              60
                  Import-Relevant Element Types                                         60
                  Meta elements in the AWE BOM                                          63
                  Element Reference / BOM ID                                            63
                  Step information                                                      64
                  Spacer                                                                67
                  Muntins                                                               72
                  Element thickness                                                     77
                  Number of sub-elements                                                77
                  Supply types                                                          78
                  Laminated foil cutting                                                79
                  IG with more than three sheets                                        79
                  Fire protection glass                                                 79



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                   5
     2.7. Ordered glass and processings after the definining processing                     82
     2.8. Processing information in OrderXML                                                83
                  Allocating Processing Steps to Elements                                   83
                  Defined processing steps for elements with a supply type other than production
                  86
                  Processing steps below a toughened sheet                                  86
                  Marking the relevant ProcPostThermal processing steps                     88
                  Processing reference                                                      89
                  A+W Processing Types                                                      89
                  Numbering of Edges for Edgework                                           89
                  Supply types                                                              90
                  Suppressing processing steps with supply type ‚none’                      90
                  Interlayer cutting as additional processing on LAMI                       91
                  Customer's own label number from EDI order overwrites own label number 91
                  Location-spanning PDC                                                     91
     2.9. Customized information in OrderXML                                                94
                  Configuration of SPs and texts                                            94
                  Stored Procedures                                                         96
                  Texts                                                                    107
     2.10. Internal client separation                                                      113
                  Company change in the order after transfer to AWP                        113
     2.11. A+W Processing Types                                                            115
                  UV protection (awtyp 1650)                                               115
                  Configure/non-configured processing parameters                           115
     2.12. AWE item types                                                                  116
                  Other articles (atyp 999)                                                116
     2.13. Extended Workbench (EWB)                                                        116
     2.14. DB switch - Status feedback / rack feedback when switching to a new ERP
     database (e.g. multisite system)                                                      118
     2.15. Interesting facts                                                               120
                  Error reports in the Windows service log                                 120
                  No orders are processed                                                  120
                  List of form vectors                                                     121
                  Invalid special characters                                               121
                  Manual transfer of orders                                                122
                  Processing step assembly or cutting                                      122
                  If the database is inaccessible                                          124
                  Glass door systems and shape data                                        125
                  Weight of main and sub parts                                             125
                       Ordering types and their significance                               127
     2.16. Other documents                                                                 128
     2.17. Annex: A+W processing Type Information                                          129
3.   AWP Connection                                                                       132
     3.1. Overview                                                                        132
                 Motivation and goals of this development                                 132
                 Components of the connection                                             132
                 Process description of the connection                                    133
     3.2. Functions                                                                       134
                 Postponement of delivery date                                            134
                 Calculation of dates for the receipt of goods                            135



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                         6
               Order generation                                                           136
               Cost calculation - General                                                 140
               Cost calculation - logical and physical machines                           142
               Stock forecast                                                             143
               Stock removal - reporting of stock plates (XTV)                            147
               Resolving reservations in the warehouse forecast for XTV feedbacks         148
               Consideration of item splits when the successful scheduling is confirmed   150
               Status confirmations production                                            150
               Status feedback racks                                                      152
               Provision of cost centers                                                  156
               Treatment of orders with high priority (AWDesk #447496)                    156
               AWP transfer cost calculation + reservation - [AW-126899]                  156
               Forced errors                                                              157
               Transfer of purchase information to AWP                                    157
               Reporting of an element exchange                                           157
   3.3. Data structure                                                                    158
               awc_bestproto                                                              158
               awc_fertigmeldungen                                                        158
               awc_modparams                                                              159
   3.4. Feedback object from AWP                                                          159
   3.5. Environment variables                                                             159
               AWC_ALCIM_ANBINDUNG                                                        159
               AWC_ART_HZEIT (PMCHZEITART)                                                159
               AWC_MIN_HZEIT_KUNDE (PMEDASCHMINHZEITKUND)                                 160
               AWC_MIN_HZEIT_LIEFERANT (PMEDASCHMINHZEITKUND)                             160
               AWC_DEF_ROUTENABFAHRT (PMEDASCHROUTENABFAHRT)                              160
               AWC_BESTELLEN_BIS (PMEHEUTEBZEIT)                                          160
               AWC_FIXIERT_AB (similar to PMXCIMRMSTATI)                                  160
               AWC_FREIGEGEBEN_AB (similar to PMXCIMRMSTATI)                              160
               PMVERSANDSTEUER                                                            160
               AWC_URL_PRODUKTIONSBERICHT                                                 161
               AWC_GESTZU_BUCHEN                                                          161
               AWC_GESTZU_BUCHEN_OHNE_VERPACKTMELDUNG                                     161
               AWC_IGNORE_PACKINGMESSAGE                                                  161
               AWC_IGNORE_AWERACKSTATUS                                                   161
               AWC_WAEIN_UEBERMITTLUNG                                                    161
               AWC_BUCHE_KPOSPROD                                                         161
               AWC_ALCIB_SERVER_NAME                                                      161
               AWC_PORT_RPC_DIENST                                                        162
               AWC_PORT_CONTROL_SERVER                                                    162
               AWC_IGNORIERE_GESTELLMELDUNG                                               162
               GESTELL_BDE                                                                162
               AWC_RACKSTOCK_REGPOINT_TYPE                                                162
               AWC_NACHBEST_MANR                                                          162
               PMEINBTERMINAENDMANR                                                       162
               PMEZKBESTELLT                                                              163
               SPLIT_POSKOST_COSTS                                                        163
               BEST_LOCK_TEST                                                             163
               BEST_LOCK_TEST_SPERRE                                                      163
               KAUFUPDATE_BEI_BEST                                                        163
   3.6. Switches in AWP (formerly ALCIM)                                                  163



A+W Software GmbH     EN-CONFIG-A+W Enterprise Production Interface.docx                        7
               Switch for loading OrderXML files.                                       164
               Switches without Common base                                             164
               Additional AWP switches for AWE-AWP communication                        166
               PF tickets with AWP configuration problem                                167
   3.7. System messages                                                                 167
               Status 73 - Scheduling or rescheduling failed                            167
               Status 74 - Postponement of delivery date                                167
               Status 43 - A broken product contains purchase order parts which have to be
         reordered                                                                      167
   3.8. Logging                                                                         168
               Report (CompleteScheduling) about the ERP Webservice                     168
   3.9. Troubleshooting                                                                 168
               Grinding allowance missing in the PO feedback                            168
               During scheduling, references are not found                              168
               Shape change for purchased part                                          170
               Crash of the OrderXML Service                                            170
               ProcPostThermal processings in der OrderXML transfer on the wrong lite 171
               Order too large for current ERP Webservice configuration                 171
   3.10. Appendix                                                                       172
               Stock forecast in version 2009 and configuration options                 172
               Generation of remake purchase orders                                     172
               Workflow of background processes                                         175




A+W Software GmbH     EN-CONFIG-A+W Enterprise Production Interface.docx                      8
1. System diagram
...
A+W Software GmbH    EN-CONFIG-A+W Enterprise Production Interface.docx   9
...
in a separate chapter.
                        ...
                        Amendments compared to the previous version
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           10
...
ALCIB which are completely supported by the OrderXML service.
                     ...
                     Information about previous versions of A+W
               Enterprise OrderXML 6
The documentation for the versions before A+W Enterprise OrderXML 6 (for example, version
2011/4.5) can be found here: \\jupiter\Doku_DocuWare\Interfaces\OrderXml\AusAlcib
...
The above graph shall visualize the general process.
...
A+W Software GmbH           EN-CONFIG-A+W Enterprise Production Interface.docx                        11
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           12
...
A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                     13
                          463: No items found to
                          ...
                          498: Windows service could not write the reported data
                                in a file.        (possible reason: disk full)
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      14
...
would be required. Extensions are possible. The table is structured as follows:
    ...
    •   Typ          Tells the OrderXML service the type of data used for this record. Currently
        ...
        4           = scheduling
        128         = cost calculation + reservation - [AW-126899], description in
        special chapter
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           15
...
available, the available ones are processed and the system correctly realizes that there are no
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           16
...
used
    •   For fail safety: If one of the computers on which an OrderXML service is installed fails,
...
system. As long as an order is processed by one OrderXML service, it cannot be accessed by any
...
With regard to fail safety please note: If one OrderXML service fails during the write process, it
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                            17
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                            18
...
This is standard behavior now which can be switched off if the order is not edited, or if the
...
tool is automatically started by the SetupLauncher; it can also be started by hand in the Windows
Start menu in All programs > Albat+Wirsam > Config Tools.
The database settings are made in the second dialog of the OrderXML service:




A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         19
...
A+W Software GmbH          EN-CONFIG-A+W Enterprise Production Interface.docx                            20
...
much on the individual circumstances and from the customer’s practical values. This is why the
values can be adapted later on.
...
A+W Software GmbH           EN-CONFIG-A+W Enterprise Production Interface.docx                      21
...
imported order so that the second service realizes that this order is already being processed.
...
The Windows service has to be rebooted after changing the settings in the configuration file.
                         ...
                         Fileless transfer via AWSOA Planning Import Service
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         22
...
Note:
Tracing is useful for searching and should also be used especially in the set-up phase. Recording
should however be switched off during operation. Tracing is quite time-consuming.

Switches for the Windows Service Tracing

Tracing is set in the third dialogue of the configuration tool which is accessible in the Windows
start menu, All Programs > Albat+Wirsam > Config Tools.




A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          23
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       24
...
The following switches are mandatory for the process:
    •   MODUL_KOSTENKALK: This variable must be '2' only if the transfer is not made to ALCIM
        by Alcim Capacity. This way, the background process after the release of the order is
    ...
    •   BYTE_VEKTOR
        The byte vector environment is necessary for determining the relevant edge for
...
If ALCIB transfers orders to the OrderXML service, they are prioritized by default so that rush
orders will always be processed first while standard orders will be handled before orders that are
just transferred for cost calculation purposes. Prioritization is done in the field lfdnr in table
ottransfer. The higher the entry here, the earlier will the order be processed by the OrderXML
service.
Should these hierarchy levels be insufficient, a customized solution can be set up by means of SP
cu_orderxmlpriori .




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           25
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      26
...
After creation and test, the SP must be enabled by means of a configuration table (see also
sections "Customized information"). Since this logic has been introduced only by a patch version
of the OrderXML service, the SP cuxmltransfer may not be listed in the configuration table yet. In
...
A+W Software GmbH          EN-CONFIG-A+W Enterprise Production Interface.docx                       27
2.4. Environment variables
                      ORDERXML_NOSTOCKPLATES
   ...
   See AWDesk #448684.
                      ...
                      ORDERXML_PROCPOSTDEF_LEVELDOWN
    ...
    See AWDesk #461345
                      ...
                      ORDERXML_PROCPOSTDEF_LEVELDOWN_MODE
      Site reference: order
      If this variable is active with a value > 0 and the variable
      ORDERXML_PROCPOSTDEF_LEVELDOWN is also active, for an ordered parent part,
      processing that takes place after the defining processing is transferred in the OrderXML
      file on the glass below the ordered glass. Here the stored mode will be used. In no case
      may the procurement type of the ordered glass be changed to "Production" after the fact
      in A+W Production with this logic.
      Only possible variant:
      Value "1": if the variable is active with the value "1", A ProcPostThermal processing on the
      only TG below the ordered part is transferred if there are several kinds of glass below the
      ordered part.
      [AW-159250]


                      ORDERXML_ENDCUSTOMER_DETAILS
      Client reference: no
...
A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                        28
                         ORDERXML_POSTPROCTHERMAL_ON_TVG
        During production transfer, it could happen that BOM elements for which the "After
        furnace" indicator is entered in the article were transferred to the float glass as
        processing. This behavior has been corrected. For the changed behavior the switch
        "ORDERXML_POSTPROCTHERMAL_ON_TVG" must be activated.
        See AWDesk #460528.


        During the creation of the OrderXML file, the case can occur that a stamp on the
        tempered safety glass is transferred to the float glass. This behavior can be disabled by
        setting the ORDERXML_POSTPROCTHERMAL_ON_TVG switch to ON. For downward
        compatibility the behavior could not be deactivated generally.
        See AWDesk #459758.


        With AWDesk #426220, a logic was implemented that a stamp is always applied to the
        underlying float glass for a produced TGH. This logic was expanded to special lites and
        patterned glass.
        The entire logic can be deactivated with the switch
        "ORDERXML_POSTPROCTHERMAL_ON_TVG".
        See PF [AW-83155].
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           29
                             How to read the documentation text file
...
A+W Software GmbH             EN-CONFIG-A+W Enterprise Production Interface.docx                             30
Directory
...
12-12 17-35-24.xml.
Since PF [AW-70328]:
For the generation of OrderXML files, the desired delivery date is added to each file name.
Example:
order123i0e5t2021-05-17 10:02:20w2021-06-01.xml
If in A+W Production the appropriate functionality is enabled, the files are processed in date
sequence (earliest first). For details, the appropriate release notes can be read from the A+W
Production.
...
2010-12-12 17-35-24     Time stamp showing when the compilation of information has begun. The
                        time stamp consists of: year – month – day hour – minute – second.
w                       Separator and flag that follows the date stamp of the delivery date. [AW-
                        70328]
2021-06-01              date stamp delivery date in the format: year - month - day. [AW-70328]
[.highPrio]             facultative: flag for "high priority". (#447496)
.xml                    Fixed suffix of the OrderXML file.



A+W Software GmbH          EN-CONFIG-A+W Enterprise Production Interface.docx                            31
High prio orders

See section "Treatment of orders with high priority (AWDesk #447496)".
...
The version shown in the file consists of three numbers:
    ...
    •   Sub-version (in this figure, 2): This number changes after certain information has been
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       32
...
This version number is defined at the end of the OrderXML file (in this figure, e.g. 12.1.1). It can
be used to check whether the new requirement can already be handled by the existing OrderXML
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        33
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                 34
    •   Information on the item, especially the item reference ID.
    •   Production list
        is a list of relevant elements. These are usually glass, foil, spacers or cast resin, muntins,
        and purchased elements.
    •   Customer reference
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                             35
        BOM right below the actual element. These references can be used to re-establish the
    ...
    •   Product elements
        ...
        and are therefore different for glass, foil, spacers, muntins, or other purchased elements.

        This section also includes the step information.
    •   Geometries
        Width and height of the shape parameters if necessary.
        The sizes were determined on a commercial basis. Production-related amendments like
...
date as well; this is identified by the version code "12.1.2" at the bottom of the file.
                        ...
                        ALCIB Environmentswitch
Chapter 1.3.5 „Aktivierung im ALCIB“ already explains that the ALCIB environment switches
ORDERXML, BYTE_VEKTOR and MODUL_KOSTENKALK are analyzed for the process. The following
environment switches influence the information in an OrderXML file:



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        36
   •   ORDERXML_KOMPLETTESTUECKLISTE
       By default, the BOM is only broken down as fast as this is relevant for production. This
       ...
       „before EDI" supply types can be imported and analyzed as well as for the use of the
       function „change of supply type“ in ALCIM.

       Addition on 03/04/2024: Currently there is nobody more in AWE who has an overview of
       the effects that occur if ORDERXML_KOMPLETTESTUECKLISTE is deactivated at the
       customer.
       Therefore, there is actually only the option ORDERXML_KOMPLETTESTUECKLISTE = "ON".
   ...
   •   PMCGHDICKETYP
       Apart from glass, the spacer articles like foil and IG spacers will be adopted. These articles
       are used to determine the thickness of the assembled product. In case of cast resin, the



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                         37
       system searches for an article with article type 340 by default. A PMS type can be defined
       alternatively: If an article is found in the BOM below a cast resin article which has been
       allocated this PMS type in its article master data, this article will be used as the spacer
       article.
       Here, the default is ptyp=340, too.
   ...
   •   PMXAWPOOLSPROSSEN
       muntin patterns can be described on segment level in OrderXML. For this purpose, the
       grid article is usually adopted as an element for which all muntin construction information
       will be available.
       If the grid function is not used in ALCIB, the first muntin article found in table kspross will
       be loaded instead.
       This switch can be used for grouping in this case. It defines that for all muntin articles
       allocated to a certain PMS type, the same article shall be used as the muntin element. If
       the first muntin article in kspross is allocated to a PMS type and if this PMS type is defined
       in the switch's value list, the defined article number is imported as an element.
       Note: The available PMS types are still defined in PMS. Allocation is done in article master
       data.
   •   DURCHGSPROSSE
       This switch defines the continuous muntin if this information cannot be gathered from
       the muntin type and the muntin widths. If the switch is active and ‚0’, the horizontal
       muntin is considered to be continuous. Otherwise, the vertical muntin is always
       considered to be continuous.
   •   SPROSSENGITTER
       This switch defines that ALCIB automatically adds a muntin pattern article above muntins.



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                         38
       The muntin pattern article type is 225 and has a sub-element in master data (no
       processing, preferably an element of the type 999).
       This function must be set for purchased muntins.
   •   PMXPOOL_NOAWDFILE
       ...
       case; field <ORDER ITEM - USER EXTENT - PRODUCT - PRODUCT_ELEMENTS - Item
       MuntinGrid – reference> in the OrderXML file remains blank. The ALCIB table field
       kposp.privat_char can be used for other, customer-related purposes in this case.
   •   MODUL_VERSIEGELUNGSTIEFE
   ...
   •   DATEI_REF_PFAD
       ...
       specified in OrderXML in the section (tag) "- <Attachment>" if the document attachment
       is marked for production transfer in A+W Enterprise. The transfer is always made with
       path specification. The format for such a reference is:
       <DATEI_REF_PFAD>\<kauf.auftrnr>\<kpos.posnr>\<Dateiname> (posnr is 0 if the
       document is auftragsglobal. ).
       In <DATEI_REF_PFAD>\macro the SN macro files must be saved, that are used for the
       processing types macro (type 1900) and surface macro (type 1910).
   ...
   •   PMEHANDLE_GERADE_EP
       ...
       such an element will be adopted in reverse order. This is standard behavior as from
       Version 2012.




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                            39
   •   PMEHANDLE_EP0
       This switch is used to define a fixed assembly position for glass and foil layers if no
       ...
       an even assembly position, the glass or the foil layer is allocated the number 2. Otherwise,
       the assembly position is assumed to be 1.
   •   PMEKOPF_EP
   ...
   •   MODUL_DOPPELSCHICHT
       ...
       Whether a glass is coated or structured is defined in the master article data. The side of
       the coating/structure (viewed from the outside top or bottom) depends on the
       installation position of the glass in the order bill of materials.
       In a simple glass hierarchy the layer can generally only be assigned to one side. This is
       determined by the installation position on the top bill of materials level.
       Other operations that also perform coating have a different aspect. The peculiarity here is
       that glasses are coated double (or even triple in some cases) or that already coated
       glasses (from purchase or BM cut) are coated once again (either on the same or on the
       opposite side). An alternative logic shall be available in the future via respective system
       configurations.
       In this logic, the presence of a layer in the master data means that a new layer was
       applied and the installation position in the bill of materials specifies on which side. In case
       of active logic, an installation position can be defined on each level of a simple glass
       hierarchy. For example, if a glass already has a layer at the bottom due to its installation
       position (installation position 2) and if a glass is now installed which is also allocated
       installation position 2, the resulting glass is considered doubly coated (hereby, the glass
       rotation based on even installation positions has to be considered).
       This new logic, if active, shall also be considered at the transfer to the production system
       by way of Order XML. This type of recording affects the determination which glasses have
       to be rotated for the cut or the purchase in the A+W production.
       The conversion of the existing processes occurs via the background process intauf (art = -
       70). In order to execute the conversion, please contact your project planner or our
       service.
       In order to activate the new logic, the switch MODUL_DOPPELSCHICHT has to be
       activated and the value has to be set to "ON".
       Whether an existing OrderXML-service already evaluates various installation positions in a
       simple glass hierarchy can be detected from the version detection below in a current
       OrderXML-file: In version 2011 it has to contain at least the value 3.6.45 and in version
       2012 at least the value 12.1.11.



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                          40
       The intauf (Art = -70) revises all respective processes. In order to avoid double processing,
       a CU table cu_dpschicht is required. (Script for setup is in CUST/sql of version 2013).
   •   KATALOGART
   ...
   •   USER_ID        Analysis is already planned for possible, customized extensions. It is part
   ...
   •   ORDERXML_FOLIENZUSCHNITTSBESCHAFFART If this switch is active and ON, the supply
       type of a laminated glass foil shall be changed to „cutting“ if the supply type of the foil in
       ALCIB is „Producion“ and if it scheduled for cutting (appropriate AW-Typ or Atyp).
       Especially if the production system is ALCIM, this is sensible only if the foil layers are to be
       optimized, and if stockplates have been defined.
   ...
   •   AWC_ANGEBOT_DEF_TERMIN
       No delivery date is required for quotations. In this case, the current date plus 14 days is
       transferred to A+W Capacity as the default date. The offset of 14 days prevents a general
       date shift for quotations. If this value does not match, you can use this switch to specify a
       different value in days.
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                            41
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         42
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        43
Change of plant for an order

In case of internal site separation , the allocated site can be changed in the ALCIB order header.
The OrderXML service recognizes the change of plant based on the data in table ottranssav
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        44
...
are a counter which show that an item has been split because it was loaded onto several racks.
Element reference
...
The processing reference matches the processing step's tupel number in the ALCIB BOM.
                        ...
                        OrderXML files for purchase orders
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        45
...
The entry in the transfer table therefore does not depend on the switch ORDERXML.
...
corresponding address master data will be determined; otherwise, the information from partner
master data will be used.



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           46
Shipping address (DELIVERY_PARTY)
For drop shipments, the address is determined from address master data if kauf._ladrnr shows an
...
Bill of materials
The procurement type of the main element of a purchase order is usually "Route." For
orders/quotations, this supply type generally means that the BOM below is irrelevant for
production. The supplier however needs the BOM of the ordered element. This is why the whole
BOM will always be transferred for purchase orders!
...
All OrderXML files for purchase orders will be saved in this directory.
                     ...
                     OrderXML transfer just for production cost
              calculation
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                          47
...
quantities in quotation items to calculation quantity 1 by the OrderXML service.
                     ...
                     Items with supply type "none" in the OrderXML
              interface
...
The switch will not be analyzed if the OrderXML file is required for direct data import from PMS to
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         48
...
The adjustment of the OrderXML is implemented in Version 5.5 using two stored procedures.
It is necessary to activate the two SPs with the 'INFOTOXML' tool. The set 7 described under 3.
must be defined as order header level.
SP cupmawpaktext1
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       49
...
\\hausi\AWDCaseDoc\345\345567\345567 ReleaseNotes.docx
The environment variable ORDERXML_ENDCUSTOMER_DETAILS must be active.


                  Automatic creation of rack groups and additional
             parameters for PMO
AWP now permits the automatic creation of rack groups. The groups are defined by formulas
which, after initial implementation, you can define or adapt yourself.
Rack optimization allows the transfer of new parameters so that the RUL files can be kept much
simpler.

Appropriate PMO commands must be defined for order items to be taken into account for
automatic rack group creation. These commands include the definition for group creation as well
as the values for the new parameters. The commands are defined in the ERP system and are
transferred via OrderXML file interface. To enter the data in the ERP system, the Set 4 of the
private document fields (kaufprvfld) is available ("see EN-CONFIG-A+W Enterprise Customizing")

A PMO command consists of keywords and allocated values or instructions. An example could be:
“#CIMGROUP=2 #PMOGROUP=1 #PMOSET=1 #PMOTAG=1 #RUL=boxing.rul #1=2 #2=50.0
#3=50.0 #4=50.0 #5=3250.0 #6=2400.0 #7=1200.0 #8=1000.0 #9=5.0 #10=150.0 #11=250.0 #12=4
#13=2 #STRATEGY=401 #REFILL=1 #KEEPSEQPATTNTOGETHER=1”.
The following keywords can be analyzed:

    -   #CIMGROUP: The number following the keyword is an ID referring to a formula (see
        Master Data). This formula will be executed at automatic rack group creation.
    -   #PMOGROUP: The number following this keyword is an ID referring to a formula (see
        Master Data). This formula will be analyzed upon transfer to rack optimization. The result
        is transferred as a new parameter to PMO where it is used to create sub-groups.
    -   #PMOSET: The number following this keyword is an ID referring to a formula (see Master
        Data). This formula will be analyzed upon transfer to rack optimization. The result is
        transferred as a new parameter to PMO and defines what shall be kept together.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       50
   -   #PMOTAG: The number following this keyword is an ID referring to a formula (see Master
       Data). This formula will be analyzed upon transfer to rack optimization. . The result is
       transferred as a new parameter to PMO and defines the sequence within the set.
   -   #RUL: Name of the RUL file to be used by PMO.
   -   #1, #2, ..., #29: Enter the values of the relevant parameters for the RUL file.
   -   #STRATEGY: This key defines an optimization version which is transferred to PMO as a
       new parameter. The entry consists of three digits.
       Digit 1 defines the PMO mode and can have the following values:
       1 – Mono stack mode
       2 – Multi stack mode
       3 – Peripheral mode
       4 – Mode completely free
       Digit 2 defines the PMO sequence for unloading and can have the following values
       0 – PMO sequence for unloading
       1 – Sort orders in ascending order for unloading (++)
       2 – Sort orders in descending order for unloading (--)
       3 – Sort items in ascending order for unloading (++)
       4 – Sort items in descending order for unloading (--)
       5 - Sort orders in ascending order for unloading (++) and items in ascending order (++)
       6 - Sort orders in descending order for unloading (--) and items in ascending order (++)
       7 - Sort orders in ascending order for unloading (++) and items in descending order (--)
       8 - Sort orders d in descending order for unloading (--) and items in descending order (--)
       Digit 3 defines the PMO rule:
       0 – PMO rule
       1 – Basic rule (orders on one rack)
       2 - Max 2 racks (orders on max.2 racks)
       6 – M1: Basic rule and by side and en bloc
       7 – M2: Basic rule and by side and en bloc
       8 – Unload orders en bloc and by side
       9 – Orders en bloc (on successive racks)
       Nearly all combinations of digits are possible, only the sequences 1 and 2 must not
       combined with rules 6 and 7; these combinations would produce poor optimization
       results.
       Definition of key #STRATEGY is optional. If it is missing, 400 is transferred by default to
       PMO.
   -   #REFILL: The value of this key can be 0 or 1; it is transferred as a new parameter to PMO.
       It defines whether racks from different groups shall be pooled (0 = pool, 1 = do not pool).




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                           51
        Input of this key is optional. If it is missing from the PMO command, 0 will be transferred
        by default.
    -   ·#RACKCOST: The value of this key can be 0 or 1; it is transferred to PMO as a new
        parameter. It defines whether rack costs shall be optimized (1 = optimize rack costs, 0 =
        do not optimize rack costs). Input of this key is optional. If it is missing from the PMO
        command, 0 will be transferred by default.
    -   ·#DOUBLESTEP: The value of this key can be 0 or 1; it is transferred to PMO as a new
        parameter. It defines whether DoubleStep® optimization is desired (1 = yes, 0 = no). Input
        of this key is optional. If it is missing from the PMO command, 0 will be transferred by
        default.
    -   #IGNOREPRODLINES: The value of this key can be 0 or 1; it is transferred to PMO as a new
        parameter. It defines whether the allocation to production lines shall be ignored (1 =
        ignore allocation, 0 = do not ignore allocation). Input of this key is optional. If it is missing
        from the PMO command, 0 will be transferred by default.
    -   #REVERSERACKS: The value of this key can be 0 or 1; it is transferred to PMO as a new
        parameter. It defines whether the rack sequence shall be reversed at the end (1 = reverse
        sequence, 0 = do not reverse sequence). Input of this key is optional. If it is missing from
        the PMO command, 0 will be transferred by default. (1 = keep together, 0 = do not keep
        together).
   -    #KEEPSEQPATTNTOGETHER: The value of this key can be 0 or 1; it is transferred to PMO
        as a new parameter. It defines whether items shall be kept together. Input of this key is
        optional. If it is missing from the PMO command, 0 will be transferred by default.

The keys in the PMO command can be arranged in any sequence.

Functioning of the automatic rack group creation
To start the automatic group creation, mark the relevant items in one of the rough scheduling
views, then select the new menu item Automatic rack group creation from the context menu.

The function checks whether the requirements for execution are met. These requirements are:
    - Only items which have not been allocated to a rack group can be taken into account.
       Items already belonging to a rack group will remain unconsidered.
   -    All items have to have a valid PMO command assigned. A command is valid if the key
        #CIMGROUP is defined. The ID must be defined in master data. A RUL file must be
        entered via the key #RUL; this must be an existing RUL file.
        If an item is found without a valid PMO command assigned, the function will be aborted
        on an error report. The item can either be removed from the selection, or the item's PMO
        command must be corrected first.
When the requirements are met, the formula defined by key #CIMGROUP will be executed for
every item. The formula has to return a string which is used as a group string.

Grouping follows: All items for which the same group string has been determined and for which
the other keys and key values in the PMO command are identical (the sequence in which they
occur is irrelevant), will be allocated to the same rack group.

Configurable formulas will be executed for the master group name and for the group name. To
guarantee the uniqueness of these names, the group name is completed by a serial number. If no



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           52
formula has been defined for the name of the master group, every created group will
automatically be given the master name „AUTOMASTER“. If no formula has been entered for the
group name, the name of the RUL file – completed by a serial number – will be used.

Please note that you can form maximally 99 rack groups with one function call. There are still
items left for which no group has been formed yet, this will be reported. Please select the menu
item Automatic rack group creation once more in this case.

Master data
As explained above, the values of the keywords #CIMGROUP, #PMOGROUP, #PMOSET, and
#PMOTAG are IDs which refer to formulas.
There are four new master data dialogues in menu Master data > PMO for defining these IDs:

      -   Menu item ALCIM rack group formulas brings you to the dialog for defining the formulas
          for key #CIMGROUP.
      -   Menu Rack group formulas gives access to the dialog for defining the formulas for key #
          PMOGROUP.
      -   ·Menu item Sub-group formulas is used to go to the dialog for defining the formulas for
          key # PMOSET.
      -   Menu item Sorting formulas brings you to the dialog for defining the formulas for key #
          PMOTAG.

Three fields can be defined:

ID:              This is the unique ID referring to the formula. This ID must be allocated as a value
                 to the corresponding keyword. When you enter a new record, the program will
                 suggest a unique number. This number can be changed but must still be unique.

Description:     Enter a short description which shall help you select the record.

Formula ID:      This is the ID of the formula to be executed. If known, the value can be entered by
                 hand. We recommend selecting the formula via formula editor however.

The formula editor is accessed by pressing the key [Formula]. You can enter any number of
formulas here, and select one.
The button for the formula editor is always active so that new formulas can be defined or existing
formulas changed anytime. A formula will be allocated to a record in the dialog only if [New] or
[Amend] has been selected before. Since this button is always active, you can change the
formulas for the names of the master group and for the group for automatic group creation
anytime.

Formula parameters
The following parameters (properties) can currently be used in PMO formulas:

ITEM_AUFTNR: This is the order number to which this item belongs (pool_pos.auftnr). This value
             will always be 0 for the formulas for the master group name and the group name
             because different orders may be involved.

ITEM_POS:        This is the item number of the current item (pool_pos.pos). This value will always
                 be 0 for the formulas for the master group name and the group name because
                 different items may be involved.



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                       53
ITEM_U_POS: This is the sub-item of the current item (pool_pos.u_pos). The keys Order
            Number, Item Number, and Sub-item Number clearly refer to an item. This value
            will always be 0 for the formulas for the master group name and the group name
            because different items may be involved.

ITEM_KD_POS: This is the customer item reference if defined for the current item.

ITEM_KOMMISSION1: This is the first consignment defined for the current item.

ITEM_KOMMISSION1: This is the second consignment defined for the current item.

ITEM_ORIENTATION:      Position of the product on the rack (pool_pos.orientation). This value will
                       always be 0 for the formulas for the master group name and the group
                       name because different items may be involved.

ITEM_PACKING_MODE: This is a packing method (pool_pos.pack_method). This value will always
                   be 0 for the formulas for the master group name and the group name
                   because different items may be involved.

ITEM_RACK_FAMILY:      Represents a rack group (pool_pos.rackfamily). This value will always be 0
                       for the formulas for the master group name and the group name because
                       different items may be involved.

IS_MASTERPART_PROCESSED: Is 1 if the main element is still being processed; otherwise 0. An
                         element is considered to be processed if there are other
                         processing steps apart from the defining processing step, except
                         packing or shipping. The processing steps packing/shipping are
                         recognized based on the allocated A+W processing type or, if this
                         has not been set, based on the production type; if the value is
                         1800 or 1810, this is not recognized as a processing step. This
                         value will always be 0 for the formulas for the master group name
                         and the group name because different items may be involved.

LOCKING_STATION:       Is the lock station, i.e. the code of the station which has selected/grouped
                       the items for automatic rack group creation. The relevant items are listed
                       by this lock station in table pool_selektion. Since there is no such selection
                       at PMO transfer however, there will be no entry for the formulas Rack
                       Group, Sub-Group, and Sorting.

PRIORITY_REALMACHINE:          Defines the priority of the logical machine by which the item's
                               main element is produced. This is e.g. the priority of the IG line if
                               the main element is an IG unit, or a furnace if the main element is
                               a toughened sheet. The priority can be defined in the logical
                               machine's master data. It can be used for sorting or grouping
                               purposes. The entry for the master group name and the group
                               name will always be 0 because different items and therefore
                               different main elements can be involved.

RUL_FILE:              Name of the RUL file. The name is the same for all items of a rack group.
                       This parameter is therefore set and usable for all formulas.



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                        54
ORDER_CUSTOMERNUMBER: Customer number according to the order
                      (pool_auftrag.kunde_nr). This value will always be 0 for the
                      formulas for the master group name and the group name because
                      different orders may be involved.

ORDER_DELIVERY_DATE:         Delivery date according to the order (pool_auftrag.lief_term).
                             There will be no entry for the formulas for the master group name
                             and the group name because different orders can be involved.

ORDER_DELIVERY_NAME:         Name according to the shipping address
                             (pool_auftrag.lief_name1). There will be no entry for the formulas
                             for the master group name and the group name because different
                             orders can be involved.

ORDER_DELIVERY_NAME2:        Supplementary name according to the shipping address
                             (pool_auftrag.lief_name2). There will be no entry for the formulas
                             for the master group name and the group name because different
                             orders can be involved.

ORDER_DELIVERY_STREET:       Street according to the shipping address
                             (pool_auftrag.lief_strasse). There will be no entry for the formulas
                             for the master group name and the group name because different
                             orders can be involved.

ORDER_DELIVERY_ZIPCODE_CITY:         Post code according to the shipping address
                                     (pool_auftrag.lief_plz_ort). There will be no entry for the
                                     formulas for the master group name and the group name
                                     because different orders can be involved.

ORDER_DELIVERY_CITY:         Destination (pool_auftrag.lief_ort). There will be no entry for the
                             formulas for the master group name and the group name because
                             different orders can be involved.

ORDER_DELIVERY_POBOX:        The post box according to the shipping address
                             (pool_auftrag.lief_postfach). There will be no entry for the
                             formulas for the master group name and the group name because
                             different orders can be involved.

ORDER_DELIVERY_ZIPCODE_POBOX:        Post code for the post box
                                     (pool_auftrag.lief_plz_postfach). There will be no entry for
                                     the formulas for the master group name and the group
                                     name because different orders can be involved.

ORDER_DELIVERY_WEEK:         The calendar week of the delivery date, format: YYYYWW.

ORDER_RUSHORDER:             Is set to 1 for rush orders (pool_auftrag.prioritaet=0), otherwise 0.
                             The entry for the formulas for the master group name and the
                             group name will always be 0 because different orders can be
                             involved.




A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                      55
ORDER_TOUR:                     Number of the route (pool_auftrag.tour). This value will always be
                                0 for the formulas for the master group name and the group name
                                because different orders may be involved.

ORDER_TOUR_INFO:                Name of the route (pool_auftrag.tour_info). There will be no
                                entry for the formulas for the master group name and the group
                                name because different orders can be involved.

Otherwise, the formula editor is used in the same way as for other applications. Double-clicking
on a property allows to insert this property to the formula.

Dialog for manual group creation
The above description of the keys in the PMO command shows that the command can pass on
various new parameters to PMO. These parameters allow the use of new functions but also serve
to simplify the RUL files. This is why the parameters can also be defined in the dialog for manual
rack group creation now.

The dialog now offers the following additional fields:

    -   Strategy: matches the key #STRATEGY in the PMO command.
    -   Rack group formula: matches the key #PMOGROUP in the PMO command. The formulas
        defined in menu Master data > PMO > Formulas: Rack group are offered for selection.
    -   Sub-group formula: matches the key #PMOSET in the PMO command. The formulas
        defined in menu Master data > PMO > Formulas: Sub-group are offered for selection.
    -   Sorting formula: matches the key #PMOTAG in the PMO command. The formulas defined
        in menu Master data > PMO > Formulas: Sorting are offered for selection.
    -   Pooling of racks from different groups: matches the key #REFILL in the PMO command. If
        this checkbox is checked, the Optimize rack costs, DoubleStep optimization, and Reverse
        rack sequence checkboxes are automatically disabled because these functions cannot be
        used together.
    -   Optimize rack costs: matches the key # RACKCOST in the PMO command. If this checkbox
        is checked, the Pooling of racks from different groups checkbox is automatically disabled
        because these functions cannot be used together.
    -   DoubleStep® optimization: matches the key # DOUBLESTEP in the PMO command. If this
        checkbox is checked, the Pooling of racks from different groups checkbox is automatically
        disabled because these functions cannot be used together.
    -   Ignore product line allocation: matches the key # IGNOREPRODLINES in the PMO
        command.
    -   Reserve rack sequence: matches the key # REVERSERACKS in the PMO command. If this
        checkbox is checked, the Pooling of racks from different groups checkbox is automatically
        disabled because these functions cannot be used together.
    -   Keep items together: matches the key # KEEPSEQPATTNTOGETHER in the PMO command.

When all necessary parameters have been selected in the dialog, a rack group will be created (by
pressing the [OK] button). The new parameters will form an appropriate PMO command that will
be saved in the database for all relevant items (pool_pos.pmo_command). A PMO command that



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        56
was originally imported from the ERP system can therefore be edited in the dialog (exception: the
formula for automatic rack group creation remains unaffected in the command).

Please observe:
Checkbox automatic generating packing groups has nothing in common with the function for
automatic rack group creation described above. This checkbox gives access to the old logic which
is used to create rack groups based on a SP.

Internal text
Case #233929 permitted definition of a corresponding PMO command in AWE. It can be
transferred only by the OrderXML file interface and can then be found in database field
POOL_POS.PMO_COMMAND.

The formula allocations by means of the new PMO master data dialogues are saved in the new
table PMO_MASTER_FORMULA. It consists of the following fields:

TYPE   Defines the dialog in which the formula has been entered:
1 –    ALCIM group formula
2 –    Rack group
3 –    Sub-group
4 –    Sorting

ID     Number referring to the record. Must be unique together with TYPE.

DESCRIPTION Short, descriptive text.

FORMULA_ID ID of the relevant formula. Refers to FORMULA_FORMULA.MAIN_ID.

All formulas used in this connection belong to a special type (FORMULA_FORMULA.TYP). The type
number can be determined from table FORMULA_TYP with CLIENT „ALCIMPACK.DLL“.

Configuration

The ALCIM configuration dialog (Master data > Configuration) offers the following global switches:

Parameters > ALCIM > Rough scheduling > Rack organization > Formula ID: Automatic master
group name
The switch is analyzed for automatic rack group creation. Enter the main ID
(formula_formula.mainid) of the formula that determines the master group name. The formula
can be defined by formula editors that are accessible via the PMO master data dialogs (MASTER
DATA > PMO). If no main ID or 0 is entered at that point, AUTOMASTER will always be used as the
master group name.
Parameters > ALCIM > Rough scheduling > Rack organization > Formula ID: Automatic group name
The switch is analyzed for automatic rack group creation. Enter the main ID
(formula_formula.mainid) of the formula that determines the group name. The formula can be
defined by formula editors that are accessible via the PMO master data dialogs (MASTER DATA >
PMO).
If no main ID is entered or 0, the name of the RUL file - completed by a unique number - will
always be used.
The switch
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                     57
Parameters > ALCIM > Rough scheduling > [Station ID] > Rack organization > Formula execution:
Recording
is station-specific. The switch will be analyzed if a formula is executed during automatic rack
group creation or at the optimization transfer. If the switch is set to 1, execution of the formulas is
recorded in the ALCIMPACK log. This can be used to check its execution. Please set this switch to 1
only temporarily because recording is quite extensive and time-consuming.
We recommend entering formulas with evocative names for the two group names, and allocate
the relevant main ID to the switches. The customer can change these formulas as required.

New parameters in the PMI file
The new parameters to be transferred to PMO can be found by the following numbers:

2041 Transfers the grouping/sorting key the formula returns from #PMOGROUP. An empty string
is transferred by default.

2042 Transfers the grouping/sorting key the formula returns from #PMOSET. An empty string is
transferred by default.

2043 Transfers the grouping/sorting key the formula returns from #PMOTAG. An empty string is
transferred by default.

15181 Transfers the optimization version from #STRATEGY; by default 400.

15182 Transfers the optimization type from #REFILL, by default 0.

15183 Transfers the optimization type from #RACKCOST, by default 0.

15184 Transfers the optimization type from #DOUBLESTEP, by default 0.

15185 Transfers the optimization type from #IGNOREPRODLINES, by default 0.

15186 Transfers the optimization type from #REVERSERACKS, by default 0.

15187 Transfers the optimization type from #KEEPSEQPATTNTOGETHER, by default 0.

Also to be transferred:
2039 Defines whether the sheet has to be turned depending on POOL_POS.FACE and
POOL_POS.PROD_ANSICHT.
0, if FACE is free; or if PROD_ANSICHT inside and FACE inside; or if PROD_ANSICHT outside and
FACE outside.
1, if PROD_ANSICHT inside and FACE outside; or if PROD_ANSICHT outside and FACE inside.

2040 Transfers the unit's orientation from POOL_POS.ORIENTATION: 1 = horizontal, 2 = vertical, 3
= free.

Logging
After automatic rack group creation, the pool log can be used to check whether and which items
have been selected which had already been allocated to a rack group. The function did not take
those into account.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         58
All further functional steps for automatic rack group creation are recorded in the user's
ALCIMPACK log. If recording of the formula execution is active, this will also be done in the
ALCIMPACK log.

Hint on how to define a PMO command

The rack editor can be useful for defining a PMO command. We recommend to crate a rack group
for a test item in ALCIM including the necessary settings. The settings will be save in table field
POOL_POS.PMO_COMMAND. This string can be selected and completed by the key
„#CIMGROUP=<N>“ to form the template for the definitions in the ERP system's master data. This
helps to avoid spelling mistakes.

Using this function in Version 2011 requires at least the ALCIM December patch. The database
update scripts have to be run as well. Minimum requirement:

Awupdate_texte_<sprache>.xls (in the languages required)
awupdate_alcimInit.xml
awupdate_alcim_#238150_2_476_2_476.xml
Apart from that, the files for the PMO application have to be re-installed, including the RUL files
and AWK script.

For a detailed description of this function please refer to
\\jupiter\DOKU_DocuWare\ALCIM2000\PMO\Installation_Configuration\
TU_20111110_238150_AutoGruppenbildung.doc.



2.5.11.1. Changing the PMO command via SP

Extension 23.04.2025 // A+W Enterprise 6 OrderXML Service - 13.4.11794
The PMO command transfered in OrderXML from A+W Enterprise is normally determined from
the table pmogestverp field pmoparameter with key
kaufprvfld.longval3=pmogestverp.pmogestgrpid and
kaufprvfld.longval4=pmogestverp.pmoverpackid. If this command should be adapted, now a
stored procedure (SP) called cu_getpmocommand(p_orderno INT, p_vorgang SMALLINT,
p_pmocommand char(200)) can be created.
    •   If this returns NULL or an empty string, the command string stored in pmogestverp is
        used.
    •   If the SP returns another string, it is written as new PMO command string into the
        OrderXML file.
The SP is here:
/develop/alcib/14/0/de/install/xsql/cust/pm/cu_getpmocommand.sql




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           59
2.6. Elements information in OrderXML
This chapter does not expound on every single detail of the elements; these are available in the
...
The following element types will be imported:
    •   Sheets: These are only cut sizes, i.e. the article types from 100 to (exclusively) 180, and
        ...
        stocksize and below the stocksize, the individual sheets and foils. If laminated glass shall
        ...
        sheets, and the foil will be imported while the intermediate layer containing the stocksize
        in the ALCIB BOM will be ignored.
    •   Laminated glass file, article type 176. Only the foil elements are imported. Foil packets
        also have article type 176. They should be defined as meta elements the BOM of which
        includes the individual foil layers. The OrderXML file transfers the individual foil layers,
        ignoring the meta element as it were.
        The foil layers can also be entered directly in the BOM, between the sheets. Prerequisite
        is the correct assembly position for every foil layer. See the configuration instructions for
        "A+W Enterprise". The installation position of several foils (multiple foils/foil package)
        between two lites may NOT be incremented. Each foil has the installation position of the
        lite, which lies on the same BOM level in the BOM above it. Foils between lite 1 and 2
        have installation position 1 or 2; foils between lite 2 and 3 have installation 3 or 4, etc.
...
AWP report.
    •   Cast resin: This is the spacer between the individual sheets of a cast resin product which is
        ...
        data. This PMS type can be customized by means of the switch PMCGHDICKETYP.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        60
   •   Muntins: If the BOM includes muntins, one element will be imported in place of the
       muntin pattern. The structure is described in the sections below this element. See
       example:




       The grid is imported as the muntin element (article type 225). If the grid function in ALCIB
       is not used, the first muntin article found in table kspross will be imported (article type
       230 and meta element). The switch PMXAWPOOLSPROSSEN can be used for grouping in
       this case. This switch defines that for all muntin articles allocated to a certain PMS type,
       the same article shall be used as the muntin element. If the first muntin article in kspross
       is allocated to a PMS type and if this PMS type is defined in the switch's value list, the
       defined article number is imported as an element.
   •   Wood (article type 701) is handled like glass.
   •   Other elements/accessories: The following article types are recognized as accessories:
       270: Edge protection
       280: Capillary inlay
       300: Foil
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                       61
        840: Locks
        850: Handles
        870: Alarm wires.
...
another single annealed sheet. Below the spacer, a muntin is attached.
...
reference to the muntin's BOM-ID:




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                     62
...
recognized reliably if the META element which BOM it belongs to also includes a glass article type,
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        63
                        Step information
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         64
...
are entered in millimeters, they will be converted into micrometers for ALCIM. For spacers, the
...
Especially for spacers and muntins, the OrderXML file also allows for a cutback element
...
millimeters and is converted to millimeters for the OrderXML file.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      65
        Shape number     Step number      Table field from      Table field in
                                          ALCIB kstufparam      ALCIM pool_modell
...
A+W Software GmbH   EN-CONFIG-A+W Enterprise Production Interface.docx              66
          Shape number         Step number         Table field from        Table field in
                                                   ALCIB kstufparam        ALCIM pool_modell
                               6                   dmass3                  stufeneinzug6
                               7                   dmass2                  stufeneinzug7
          126                  1                   dmass1                  stufeneinzug1
                               2                   dmass1                  stufeneinzug2
                               3                   dmass1                  stufeneinzug3
                               4                   dmass5                  stufeneinzug4
                               5                   dmass4                  stufeneinzug5
                               6                   dmass3                  stufeneinzug6
                               7                   dmass2                  stufeneinzug7
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       67
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        68
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          69
...
expected.
After definition and test of the SP, the SP can be released via a configuration table (see also
section Customized information). After that, the sealing type is determined by means of the SP.
...
Spacer type
In the OrderXML file, the spacer type is found in the information junction <ORDER ITEM - USER
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                            70
    •   INTEGER: The second parameter is the internal order number kauf.aufnr.
    •   SMALLINT: The third parameter is the internal item number kpos.posnr.
    •   SMALLINT: The fourth parameter is the BOM header number kpos.poskonr.
    •   SMALLINT: The fifth parameter is the tupel number of the spacer aufstrukt.tnr.
...
expected.
After definition and test of the SP, the SP can be released via a configuration table (see also
section Customized information). After that, the spacer type is determined by means of the SP.
...
table.
Alternatively,the spacer colorcan be determined by SP cupmawptrahmenfarb . If this SP has been
defined and is active, its result has priority over the entry for the specified colour article. The SP
receives the following parameters (in this sequence):
    •   INTEGER: The first parameter is the external order number kauf.auftrnr.
    •   INTEGER: The second parameter is the internal order number kauf.aufnr.
    •   SMALLINT: The third parameter is the internal item number kpos.posnr.
    •   SMALLINT: The fourth parameter is the BOM header number kpos.poskonr.
...
After definition and test of the SP, the SP can be released via a configuration table (see also
section Customized information). After that, the spacer color is determined by means of the SP.
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                             71
                         Muntins
Presentation of information
If an item includes muntins, an element record describing the pattern will be loaded. The
information on this element record includes the whole structure, arranged by:
Horizontal muntins
Horizontal sections
Vertical muntins
Vertical sections
Since a "muntin pattern“ is described, we recommend to enable the grid function at ALCIB order
entry. (This is mandatory if muntins can be purchased). This way, the article loaded as an element
will always be clear. If the grid function is not used in ALCIB, the first muntin article found in table
...
that for all muntin articles allocated to a certain PMS type, the same article shall be used as the
muntin element. If the first muntin article in kspross is allocated to a PMS type and if this PMS
type is defined in the switch's value list, the defined article number is imported as an element.




Note for the transfer between A+W products:
By describing the individual sections, an unlimited number of different muntins is generally
feasible. The limitation of the standard should be obeyed however:
-       up to 12 horizontal and 12 vertical muntins.
-       up to 2 different horizontal muntin articles, and



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          72
        2 different vertical muntin articles
        (e.g. to depict different colours or width)
STEPPING Element
As for the spacer, a stepped record can also exist for muntins. Prerequisite is that the explicit
spacer geometry function is active (MODUL_NEUESTUFEN and MODUL_VERSIEGELUNGSTIEFE or
ISO_RAHMEN_MODELL).
The shape geometry which is adopted for the muntin pattern matches the reference geometry in
this case (see above „Steps: New step input“). The element „Valuation“ marks the reliable
geometry by an entry of 11.
The „STEPPING“ element of the muntin shows values based on the step records for the superior
...
The spacer reduction in ALCIB (kpos.aham) always describes the inside edge of the spacer.
CUTBACK element
If the item includes muntins, the same values as for the spacer's „CUTBACK“ section will be
adopted (see there) for this „CUTBACK“ section.
Several muntin patterns
An ALCIB item may include two muntin patterns in case of triple IG, if the muntin articles are
allocated to certain spacers. OrderXML will describe two grid elements in this case. They are
imported as sub-elements of the defined spacer.
Muntin pattern as a main element
Where muntin patterns are ordered internally (switch SPROSSENGITTER), it may happen that grids
are included in the item as main elements (in the receiving site's order). Such a grid pattern is
described by two elements in the OrderXML file. The grid article is the main element and
represents a type of spacer. The sub-element serves to describe the structure.
Muntin type/ continuous muntin / cross
The muntin type is transferred in field „MuntinGrid -> TypeID“. The type numbers are fixed and
describe, together with the milling depth and the trim, the muntin connection as well as the
continuous muntin . This value is determined by means of the muntin types known in ALCIB.
These will be converted.
We are now going to describe how the ALCIB muntin types are changed into OrderXML muntin
types and how the milling depth and the trim are calculated.
    •   ALCIB muntin type 1 marks a double mitre at the junctions and matches OrderXML
        muntin type 1. There is no continuous muntin. The relevant milling depth (mitre) must be
        defined in ALCIB muntin article master data. The trim will not be analyzed; the program
        always uses 0.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         73
   •   ALCIB muntin type 2 marks a continuous mitre. This means that there is a continuous
       muntin. The milling depth is a fixed value, i.e. a quarter of the width of the continuous
       muntin. The trim is always 0. There are three criteria for determining the continuous
       muntin:
       o   ALCIB environment variable DURCHGSPROSSE
       o   If there are "auxiliary" muntins, the muntin direction with the fewest "auxiliary"
           muntins
       o   If the number of auxiliary muntins is the same, the wider muntin
       o   If the muntins have the same width, a standard will be applied which is defined by an
           ALCIB environment switch DURCHGSPROSSE.
   If the continuous muntin is the vertical one, this is OrderXML muntin type 5.
   If the continuous muntin is the horizontal one, this is OrderXML muntin type 6.
   •   ALCIB muntin type 3 marks a blunt connection. This means that there is a continuous
       muntin without milling depth and trim (both will be adopted as 0 irrespective of the
       definition in master data). There are three criteria for defining the continuous muntin:
           o   ALCIB environment variable DURCHGSPROSSE
           o   If there are "auxiliary" muntins, the muntin direction with the fewest "auxiliary"
               muntins
           o   If the number of auxiliary muntins is the same, the wider muntin
           o   If the muntins have the same width, a standard will be applied which is defined by
               an ALCIB environment switch DURCHGSPROSSE.
   If the continuous muntin is the vertical one, this is OrderXML muntin type 5.
   If the continuous muntin is the horizontal one, this is OrderXML muntin type 6.
   •   ALCIB muntin type 4 is a cross with a blunt connection. The milling depth will always be 0.
       The trim for the corresponding muntin article can be entered in ALCIB article master data.
       If the trim is 0 there, half the width of the crossing muntin will be adopted.
       This type matches OrderXML type 2.
   •   ALCIB muntin type 5 is a continuous mitre, albeit with a fixed milling depth. This means
       that there is a continuous muntin. The milling depth depends on the width of the
       continuous muntin: it is 7 mm if the width is less than 45; otherwise, it is 12 mm. The trim
       is always 0. There are three criteria for determining which is the continuous muntin:
           o   ALCIB environment variable DURCHGSPROSSE
           o   If there are "auxiliary" muntins, the muntin direction with the fewest "auxiliary"
               muntins
           o   If the number of auxiliary muntins is the same, the wider muntin.
   ...
   If the continuous muntin is the vertical one, this is OrderXML muntin type 5.
   If the continuous muntin is the horizontal one, this is OrderXML muntin type 6.
   •   ALCIB muntin type 10 is adopted as OrderXML muntin type 7. All muntins are continuous.
       If the milling depth or the trim are to be taken into account, the values must be entered in
       ALCIB article master data for the corresponding muntin.



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                         74
   •   ALCIB muntin type 11 is a continuous mitre with variable milling depth. This means that
       there is a continuous muntin. The milling depth is loaded from ALCIB article master data
       for the actual muntin. The trim is always 0. There are three criteria for determining the
       continuous muntin:
           o   ALCIB environment variable DURCHGSPROSSE
           o   If there are "auxiliary" muntins, the muntin direction with the fewest "auxiliary"
               muntins
   ...
   If the continuous muntin is the vertical one, this is OrderXML muntin type 5.
   If the continuous muntin is the horizontal one, this is OrderXML muntin type 6.
   •   ALCIB muntin type 12 is adopted as OrderXML muntin type 7. All muntins are continuous.
       If the milling depth or the trim are to be taken into account, the values must be entered in
       ALCIB article master data for the corresponding muntin.
   •   ALCIB muntin type 15 is adopted as OrderXML muntin type 0. All muntins are continuous.
       If the milling depth or the trim are to be taken into account, the values must be entered in
       ALCIB article master data for the corresponding muntin.
   •   ALCIB muntin type 93 marks a double muntin. Trim and milling depth can be defined in
       ALCIB article master data. The continuous muntin is always the widest muntin unless
       auxiliary muntins have been defined for this muntin. If the continuous muntin is the
       vertical one, this matches ALCIM muntin type 8.If the continuous muntin is the horizontal
       one, this matches ALCIM muntin type 9.
       If you are using ALCIM and want to transfer data to AWDesign please note that the
       display in AWDesign matches OrderXML muntin types 5 and 6. The ALCIM muntin types
       can be used to mark special patterns however.
   •   A+W Enterprise muntin type > 500 is OrderXML muntin type 0. (see also "DE-CONFIG-
       A+W Enterprise" – Article master data – Muntins – Muntin types)


The following marginal condition should be considered
   •   Information on the muntin type and on the continuous muntin are given by grid in
       OrderXML while ALCIB can describe this by section. Please note: The muntin article
       number of the first horizontal muntin is always used as a basis for data definition. Where
       comparisons are necessary (e.g. width of vertical muntins and width of horizontal
       muntins), the articles of the first horizontal and the first vertical muntin will be used.


The conversion of ALCIB bar types into ALCIM bar types will always be made in connection with
the ALCIB - ALCIM capacity planning interface. If you are using direct import from ALCIB/PMS, the
ALCIB switch PMQCIMIN must be 3. The defined ALCIM bar type will be adopted for the table field
pool_sprossen.typ, the milling depth for pool_sprossen_seg.fraestiefe , and the trim for
pool_sprossen_seg.trim_wert .
To pass a converted bar type on to AWDesign as a correct "continuous bar" information, the
switch for the continuous bar ("CUTTED") has to be set to 5 in ALCIM.




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                      75
The following conditions should be taken into account as well:
    •   Information on the bar type and on the continuous bar are kept in ALCIM and AWDesign
        by grid while ALCIB can describe this by section. Please note: To determine the data in
        direct import or for ALCIB OrderXML, the Georgian bar article number imported into
        pool_sprossen will always be used, i.e. the article number in pool_sprossen.art_nr_w. If a
        comparison is necessary (e.g. width of the vertical bar and width of horizontal bar), the
        articles from pool_sprossen.art_nr_w and pool_sprossen.art_nr_s will be used.
    •   We recommend to check the existing AWDesign master data before starting to use the
        OrderXML interface with AWDesign. The milling depth/trim define there may have to be
        imported into ALCIB master data. The reason: After the start-up, these values will not be
        available as AWDesign will override its master data when using the OrderXML interface.
    •   This logic is available from ALCIM Version 2009 onwards. Prerequisite are the latest Build
        versions of Item4Alcim.dll, Pool.dll, AlcimRun.dll and, when using the ALCIB-ALCIM
        AWCapacity interface, also of the ERP Webservice.
    •   Unfortunately, the Georgian bar type is adopted from ALCIB 1:1 in older versions. Due to
        the complexity of defining the continuous bar, update scripts cannot be used to correct
        the existing data. Orders to be transferred to AWDesign via OrderXML should therefore
        be imported again with a new DLL. To minimise errors, we recommend (only if the orders
        come from ALCIB) to run the following updates once - manually - before starting the
        new Items4Alcim.dll (import):
        "Update pool_sprossen set typ = 0 where spr_status <2 and typ != 1 and typ != 4;"
        "Update pool_sprossen set typ = 2 where spr_status <2 and typ = 4"
    •   If no Georgian bar continuation type (see description of AWDesk #147986) is known yet,
        OrderXML files from ALCIB or ALFAK which shall be imported into ALCIM, cannot be
        directly transferred to AWDesign. Reason: The field Bargrid->typeID is analyzed
        differently.


Continuation type for AWDesign/continuous muntin
The muntin continuation type is meant for the transfer to AWDesign. Based on this type, all
systems can identify the continuous muntin and how it is determined in AWDesign. The
continuation type - in connection with the milling depth and the trim - describes the grid
connection, i.e. the way in which horizontal and vertical muntins are assembled. This information
is found in: <ORDER ITEM - USER EXTENT - PRODUCT - PRODUCT_ELEMENTS - Item MuntinGrid –
continuousType>. ALCIB sets this value depending on the muntin type (see above): Is transferred
as the muntin type
    •   1 is transferred as continuousType „none“ (no continuous muntin).
    •   2 is transferred as continuousType „none“ (no continuous muntin).
    •   3 is transferred as continuousType „vertical“ (the vertical muntin continues).
    •   4 is transferred as continuousType „horizontal“ (the horizontal muntin continues).
    •   5 is transferred as continuousType „vertical“ (the vertical muntin continues)
    •   6 is transferred as continuousType „horizontal“ (the horizontal muntin continues).
    •   7 is transferred as continuousType „both“ (both muntins are continuous).




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                      76
    •   8 is transferred as continuousType „vertical“ (the vertical muntin continues).
    •   9 is transferred as continuousType „horizontal“ (the horizontal muntin continues).
    •   Exception: The muntin has article type 235. This is a lead muntin which is transferred as
        „lead“.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         77
                         Supply types
Supply types are shown for every element type as well as for grid sections as the procurement
information. They generally match the supply types in the BOM (aufstrukt.bestellkz).
Attention: Supply types of processings are discussed in a separate chapter.
...
transfer, they will be considered only as supply type "before EDI" if they are found on the direct
BOM level right below a purchased element. This also applies if META elements are used which
usually shall be ignored. If the complete BOM is transferred - as recommended for ALCIM - the
entire BOM tree below the purchased element will be checked for EDI supply types; the system



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           78
will only stop at elements on stock or included elements. "EDI" supply types that are not selected
below a purchased element will be adopted as standard supply type.
...
s.a. “EN-CONFIG-A+W Enterprise” – Environment variable BA_VORDFUE


                         Laminated foil cutting
Laminated foil usually gets a processing step cutting in the ALCIB BOM. Normally, this does not
entail any further logic as for other glass, i.e. foil is mostly cut from a roll and does not have to be
optimized, nor does it require stockplate definitions. This is why foil the supply type of foil - unlike
that of glass - is not set from "Production" to "Cutting" in ALCIB if it is to be cut, but remains
'Production'. Changing the supply type to "Cutting" can be configured however.
The supply type of produced laminated foil can be changed to 'cutting' in the following conditions:
    •   Enable the ALCIB switch ORDERXML_FOLIENZUSCHNITTSBESCHAFFART and set it to 'ON'.
    •   The laminated foil has to consist of foil stocksize and processing 'cutting'.
Changing the supply type of foil - especially if ALCIM is the receiving production system - makes
sense only if foil can be optimized and the corresponding stockplates can be defined.
...
sequence). It is also used for the correct allocation of muntin patterns and sealants.
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         79
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                            80
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                    81
2.7. Ordered glass and processings after the definining
   processing
...
variable ORDERXML_PROCPOSTDEF_LEVELDOWN=ON (site-specific).


Effect of the env variable ORDERXML_PROCPOSTDEF_LEVELDOWN
If the variable is active, for an ordered parent part, processing that takes place after the defining
processing is transferred in the OrderXML file on the glass below the ordered glass (e.g. on the
float below a tempered safety glass).
...
Effect of the env variable ORDERXML_PROCPOSTDEF_LEVELDOWN_MODE
If the variable is active with a value > 0 and the variable ORDERXML_PROCPOSTDEF_LEVELDOWN
is also active, for an ordered parent part, processing that takes place after the defining processing
is transferred in the OrderXML file on the glass below the ordered glass. Here the stored mode
will be used. In no case may the procurement type of the ordered glass be changed to
"Production" after the fact in A+W Production with this logic.
Only possible variant:
Mode "1": if the variable is active with the value "1", a processing that lies after the defining
processing is transferred on the only TG below the ordered part if there are several kinds of glass
below the ordered part.
See also PF [AW-159250].




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         82
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                       83
Rules:
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       84
...
been found.
    •   The following processing article types are considered to be defining and are therefore
        ...
        production, 534 muntin construction
    ...
    •   The following processing article types may affect additional elements/accessories in
        ...
        594 pressure compensation, 595 UV cover, 596 inside thread, 597 chamfers, 598 molding,
        599 gluing, 540 other processing, 584 painting, 999 other
Allocation is even clearer if the processing step is allocated to an A+W processing type .
    •   The following A+W processing types are considered as defining and are therefore usually
        ...
        1600 IG assembly, 1610 cast resin assembly, 1620 spacer filling, 1640 muntin
    ...
    •   The following A+W processing types are considered to be subsequent processing steps:
        ...
        1190 other drilling, 1200 coating, 1205 frosting, 1210 sand-blasting, 1215 coloring,
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        85
...
processing steps and subsequent processing steps.


                    Defined processing steps for elements with a supply
             type other than production
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         86
...
toughened glass.
To be precise: The "Mark" ("ProcPostThermal") in master data is taken into account for
processing steps that are in the BOM hierarchy on the same level as the furnace (article type
515 or 516, or processing type 1500 or 1510) and are located behind the furnace. If the same
marked processing shall be applied to the float glass - i.e. before toughening - it must be added
to the BOM before the furnace.
For all other products (with defining processing steps other than the furnace), the following
processing steps should be added to the BOM one level higher - as recommended - i.e. below



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                            87
the processed glass. Otherwise, the BOM sequence is decisive for single annealed products:
...
parent glass if they are positioned behind the defining processing step.
                        ...
                        Marking the relevant ProcPostThermal processing
              steps
The marking of ProcPostThermal processings below a TGH is done via a configurable field in the
article master data. Two steps are required:
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                            88
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         89
Please note:
...
BOM (aufstrukt.bestellkz). The following values are transferred:
...
elements.
                        ...
                        Suppressing processing steps with supply type
              ‚none’
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                          90
...
An interlayer cutting (atyp 752) can be interpreted in two different ways. If the
interlayer cutting is applied under a foil in the AWE BOM, this is the defining
processing for the foil. If the interlayer cutting is applied in the AWE BOM under a
LAMI stock dimension, this is an additional processing with which during
production of the LAMI , the protruding foil must be cut off again after the LAMI
assembly.

This additional processing "Cut off foil on the LAMI" must be assigned in the
OrderXML transfer to the LAMI fixed dimension during production of the LAMI.

It must be noted that the interlayer cutting must be created in the master data of
the production system with the correct article type (1792).

See also AWDesk #456476.

     Customer's own label number from EDI order overwrites own
     label number
Due to a new development, the label number from kposzusatz.barcode_char was transferred to
A+W Production. This development did not take into account existing uses of the fields. The new
logic has now been bracketed with a new environment variable so that the problem no longer
occurs.
The new environment variable is called ORDERXML_BDE_BARCODE (ON/OFF). This activates the
PDC logic from #411794.


                         Location-spanning PDC
...
Production feedback and PO generation
...
and the quantity indicator are copied into the purchase order.
Internal PO transfer
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        91
...
supported yet.
The following restrictions must also be observed:
-     The excess quantity dialog in A+W Production must not be used if the location-spanning PDC
is used at the same time, as otherwise new label numbers would be generated which would not
be known in all production locations.
...
(External: Weil, Alexander 2019-07-26)
A+W Enterprise
The new SQL script for extending the bestparametertable must be executed.
è /dvlp/sql_scripts/13/0/4/130004035_bestparameter.sql
BomItem class was re-derived. The new fields are available in the class
AWCapacityErpDocumentBomItemEtinr in the ERP WebService.
A+W Enterprise 6 OrderXML Service
To transfer the barcodes to A+W Production via OrderXML, the environment variable
ORDERXML_BDE_BARCODE (ON/OFF) must be set.
Notes on the data structures used
ERP Web Service - Complete Scheduling
The values label number and PDC quantity indicator can now be received and evaluated for the
feedback of parts to be purchased. If a label number is stored with a purchased part, the value is
written according to the bestparameter.
Internal PO transfer




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         92
During the order generation in one's own location, the label number generated and the PDC
quantity identifier are drawn from the table bestparameter and written to the table kposzuSatz.
...
The environment variable ORDERXML_VERSION must have at least the value "5.4" for these fields
to be filled. The environment variable ORDERXML_BDE_BARCODE must also be set to "ON".
The values will be adopted if:
    •   the following select returns a hit
        SELECT barcode_char, barcode_int FROM kposzusatz WHERE aufnr = @AUFNR AND posnr
        = @POSNR AND dokuref = 0 AND posref = 0;




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                     93
    •   and barcode_char is not NULL or empty
    •   and barcode_int is between 0 and 9.
...
direct data import into ALCIM. Customized information could usually be determined and provided
...
Text SPs are also available. As an alternative or completion, the OrderXML interface also has its
own mechanism for creating text.



                        Configuration of SPs and texts
In A+W Enterprise Version 6, the configuration dialog for SPs and texts is called from the system
menu:
CTRL+F4 > System configuration > Production transfer




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         94
For activation of an SP, the value (value) is set to "1". For deactivation, the value is removed. For
detailed information, see section Stored Procedures.
Texts are also activated with a number > 0. The number serves the grouping or as key in A+W
Production. For detailed information, see section Texts.
The configuration records are stored in the table alpooltoxml.
(Internal info: new SPs in alpooltoxml are generated via a SQL script. see also Wiki.)


Older AWE/ALCIB versions
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         95
                             Stored Procedures
...
how it is determined from AWE data. For some bits of information, special stored procedures can
be defined alternatively to customize the information.
When switching from another interface to ALCIM/AWP please note that this interface offers the
same SPs as Direct Data Import. This shall make the change easier. It can be guaranteed that
nearly the same information can be transferred by the OrderXML interface as determined by the
Direct Data Import.
Standard information also help to minimize the project work for new installations.
...
A+W Software GmbH             EN-CONFIG-A+W Enterprise Production Interface.docx                             96
...
After that, the SP can be released. See section Configuration of SPs and texts.
An entry is shown on the configuration dialog for every SP known to the OrderXML service. Please
note that new entries can only be made by development. These entries have to be made known
to the OrderXML service by development so that they can be taken into account.
SP entries are marked in the tool by „SP“ in column Type. The Properties/Key column shows the
SP's name. Entry "1" in column Value/Set defines that the SP shall be executed by the OrderXML
service. Enter „0“ or delete the „1“ if the SP shall not be loaded any more.
Note:
Only release the SP after it has been checked and tested. If must not include any access to PMS
tables.
The change of release of an SP via the configuration dialog is activated by rebooting the Windows
service or becomes active automatically if the service starts the next cycle. The switch
„MaxNumOrders“ defines the number of orders after which the change is automatically activated.
Suggestion:
...
The following SPs can be released via the configuration dialog
...
DokuInfosOrderXMLAlcib.txt tells you where the returned information can be found in OrderXML.
    ...
    •   cupmawpaktext1:        1. customer text, e.g. for information on the delivery note.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         97
              INTEGER = kauf.aufnr (internal order number)
       Return values: CHAR(32)       = Text to be imported
   ...
   •   cupmawpakusprache: Customer language
       ...
       .
   •   cupmawpasonderkz1 1. order-related special code. Numerical value for customized
       codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
       Return values: SMALLINT        = Customized code
   •   cupmawpasonderkz2 2. order-related special code. Numerical value for customized
       codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                        98
              SMALLINT = always 0 (historical reason)
   ...
   •   Cupmawppdoclink         Additional document links to item level (not
                               order level) ([AW-110239])
       Default: -



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                         99
       Transfer parameters:
              INTEGER = kauf.auftrnr (external order number)
              SMALLINT = kauf.vorgang (type of document)
              INTEGER = kauf.aufnr (internal order number)
              SMALLINT = kpos.posnr (internal item number)
       Return values:
       INTEGER        = Type ID, that is transferred in AWP by pool_dokumente.typ
                              (can be „0“ at present, since not used yet in AWP)
              CHAR(400)       = Complete directory or file path

       If the data path is incorrect, there will be an error when scheduling.

       The SP can return one or several results, consisting of both return values. The SP can also
       return no result.

       If the SP returns no record (result), no additional document link will be generated for the
       current item.
       If in a result record the second return value (directory path) is ZERO or an empty string,
       no document link will be generated for this result record.
       These cases do not count as errors; the OrderXML creation is continued.

       The document link will be stored precisely to the position in OrderXML
       (<ORDER_ITEM><USER_DEFINED_EXTENSIONS><UDX.AW>) in the following element:
       <Attachment reserved="">
       <DocumentLink typeID="" link="Complete path" />
       </Attachment>
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                     100
              (item can be split to different racks).
   ...
   •   cupmawpppmptxt           Second SP for item-specific text
       ...
       Rückgabewerte:           Per text:
               SMALLINT         = self-defined ID for the text type
               CHAR(80)         = Text to be imported.
   •   cupmawppsonderkz1 1. item-related special code. Numerical value for customized
       codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
   ...
   •   cupmawppsonderkz2 2. item-related special code. Numerical value for customized
       codes.



A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                     101
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = always 0 (historical reason)
               ...
               SMALLINT = kpos.poskonr (BOM header number)
       Return values: SMALLINT        = code to be imported
   •   cupmawppsondertxt1 1. item-related special text. Text value for customized codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = immer 0 (historic reason)
   ...
   •   cupmawppsondertxt2 2. item-related special text. Text value for customized codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = immer 0 (historic reason)
...
A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                  102
              CHAR(2)           = historical reasons. Can consist of two blanks in a byte vector
   ...
   •   cupmawptdichttyp              By default, the sealing types are loaded from the sealant's article
       ...
       fillings. If its value shall not be analyzed, the SP can return ‚-1’.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                         103
   •   cupmawptrahmenfarb By default, spacer colours cannot be defined for the spacer itself
   ...
   •   cupmawptsonderkz1 1. tupel-based special code for the currently imported BOM
       element. Numerical value for customized codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                          104
              SMALLINT = always 0 (historic reason)
              SMALLINT = kpos.posnr (internal item number)
              SMALLINT = kpos.poskonr (BOM header number)
              SMALLINT = aufstrukt.tnr (Tupel number of the element)
   ...
   •   cupmawptsondertxt1 1. tupel-based special text for the currently imported BOM
       element. Text value for customized codes.
       Default:       -
       Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = always 0 (historical reasons)
...
A+W Software GmbH     EN-CONFIG-A+W Enterprise Production Interface.docx               105
        Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = always 0 (historical reasons)
               SMALLINT = kpos.posnr (internal item number)
    ...
    •   cupmawpvtiefe Returns the sealing depth for a spacer.
                 Sealing depth + spacer thickness define the cutback for spacers and muntins.
        ...
        Transfer parameters: INTEGER = kauf.auftrnr (external order number)
                 ...
                 SMALLINT = aufstrukt.tnr (tupel number of the imported element or processing
        article)
        Return values: DECIMAL= value for the sealing depth in millimeters.
...
The following SPs are available but are not shown in the configuration dialog
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                     106
    •
        Transfer parameters: INTEGER = kauf.auftrnr (external order number)
               INTEGER = kauf.aufnr (internal order number)
               SMALLINT = always 0 (historical reason)
...
this case.
The defined standard logic can be configured via the configuration dialog (chapter Configuration
of SPs and texts) . The dialog shows all texts that can be imported already by default. These are
the records labeled Text in field Type.
The Properties/Key field now defines the text type. We distinguish order-based, item-based, and
tupel-related text. We also distinguish created text and text entered by hand. Text can also be
allocated to different forms.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       107
...
Standard text is configured by this text type number, i.e. by means of the field Value/Set. Enter ‚0’
(zero) if the text shall not be adopted. Any entry over 0 means that this type of text shall be
determined.
...
automatically or entered by hand is immaterial.
         In connection with AWP we recommend that you use text type numbers in the 2000
range because there are no fixed numbers in this area; this section also includes the standard text
numbers.
The text types that can be determined by the service by default are listed below together with a
short description. The name listed matches the name in the tool's Properties/Key column.
...
relevant.
Note:
To enable the service to recognize the allocation of forms and text, the form vector in table auftxt
...
1.       Automatically created text
     •   1: Man. Cutting List, Order, generated
         ...
         not 0.
         If not customized already, this text is adopted with text type number 2050.
     •   512: Label       , Order, generated
         ...
         If not customized already, the text is adopted with text type number 2052.
     •   1024: Work order       , Order, generated
         The text is found in table auftxt with the keys kauf.auftxt and drupos=1 or drupos=2.
         Moreover, it must be allocated to the form Work Order. This means that the 12th flag of
         the form vector is set to 1, representing a bit value of 1024. Field auftxt.generiert is not 0.

         If not customized already, the text is adopted with text type number 2053.
     •   2048: muntin doc., Order, generated
         The text is found in table auftxt with the keys kauf.auftxt and drupos=1 or drupos=2.
         Moreover, it must be allocated to the form muntin Paper. This means that the 11th flag of
         the form vector is set to 1, representing a bit value of 2048. Field auftxt.generiert is not 0.

         If not customized already, the text is adopted with text type number 2054.




A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          108
     •   8192: Production      , Order, generated
         ...
         0.
         If not customized already, this text is adopted with text type number 2055.
     •   4096: Purchase        , Order, generated
         ...
         If not customized already, this text is adopted with text type number 2056.
2.       Manually entered text
     •   1: Man. Cutting List, Order, man.generated
         ...
         If not customized already, the text is adopted with text type number 2040.
     ...
     •   1024: Work order       , Order, man.generated
         ...
         If not customized already, the text is adopted with text type number 2043.
     •   2048: muntin doc., Order, man.generated
         The text is found in table auftxt with the keys kauf.auftxt and drupos=1 or drupos=2.
         Moreover, it must be allocated to the form muntin Paper. This means that the 11th flag of
         the form vector is set to 1, representing a bit value of 2048. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2044.
     •   8192: Production      , Order, man.generated
         ...
         If not customized already, the text is adopted with text type number 2045.
     •   4096: Purchase        , Order, man.generated
         The text is found in table auftxt with the keys kauf.auftxt and drupos=1 or drupos=2.
         Moreover, it must be allocated to the form P.O. This means that the 10th flag of the form
         vector is set to 1, representing a bit value of 4096. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2046.
Additional, order-specific text can be determined by the SP cupmawpaauftxt (see above).
Item-specific text



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          109
1.       Created text
     •   1: Man. Cutting List, tnr=0, generated
         ...
         If not customized already, this text is adopted with text type number 2020.
     •   512: Label       , tnr=0, generated
         ...
         If not customized already, the text is adopted with text type number 2022.
     •   1024: Work order       , tnr=0, generated
         ...
         not 0.
         If not customized already, the text is adopted with text type number 2023.
     •   2048: muntin doc., tnr=0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus
         tnr=0. Moreover, it must be allocated to the form muntin Paper. This means that the 11th
         flag of the form vector is set to 1, representing a bit value of 2048. Field auftxt.generiert is
         not 0.
         If not customized already, the text is adopted with text type number 2024.
     •   8192: Production      , tnr=0, generated
         ...
         auftxt.generiert is not 0.
         If not customized already, this text is adopted with text type number 2025.
     •   4096: Purchase        , tnr=0, generated
         ...
         If not customized already, this text is adopted with text type number 2026.
2.       Manually entered text
     •   1: Man. Cutting List, tnr=0, man.generated
         ...
         If not customized already, the text is adopted with text type number 2000.
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         110
         the form vector is set to 1, representing a bit value of 512. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2002.
     •   1024: Work order       , tnr=0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus
         tnr=0. Moreover, it must be allocated to the form Work Order. This means that the 12th
         flag of the form vector is set to 1, representing a bit value of 1024. Field auftxt.generiert is
         0.
         If not customized already, the text is adopted with text type number 2003.
     •   2048: muntin doc., tnr=0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus
         tnr=0. Moreover, it must be allocated to the form muntin Paper. This means that the 11th
         flag of the form vector is set to 1, representing a bit value of 2048. Field auftxt.generiert is
         0.
         If not customized already, the text is adopted with text type number 2004.
     •   8192: Production       , tnr=0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus
         tnr=0. Moreover, it must be allocated to the form Production Paper. This means that the
         9th flag of the form vector is set to 1, representing a bit value of 8192. Field
         auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2005.
     •   4096: Purchase        , tnr=0, man.generated
         ...
         If not customized already, the text is adopted with text type number 2006.
...
1.       Created text
     •   1: Man. Cutting List, tnr>0, generated
         ...
         If not customized already, this text is adopted with text type number 2030.
     •   512: Label        , tnr>0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         ...
         If not customized already, the text is adopted with text type number 2032.
     •   1024: Work order       , tnr>0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          111
         tupel number of the current element. Moreover, it must be allocated to the form Work
         ...
         If not customized already, the text is adopted with text type number 2033.
     •   2048: muntin doc., tnr>0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         tupel number of the current element. Moreover, it must be allocated to the form muntin
         Paper. This means that the 11th flag of the form vector is set to 1, representing a bit value
         of 2048. Field auftxt.generiert is not 0.
         If not customized already, the text is adopted with text type number 2034.
     •   8192: Production       , tnr>0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         ...
         If not customized already, this text is adopted with text type number 2035.
     •   4096: Purchase        , tnr>0, generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         ...
         If not customized already, this text is adopted with text type number 2036.
2.       Manually entered text
     •   1: Man. Cutting List, tnr>0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         tupel number of the current element. Moreover, it must be allocated to the form Manual
         ...
         If not customized already, the text is adopted with text type number 2010.
     •   512: Label        , tnr>0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         tupel number of the current element. Moreover, it must be allocated to the form Label.
         This means that the 13th flag of the form vector is set to 1, representing a bit value of
         512. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2012.
     •   1024: Work order       , tnr>0, man.generated
         The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
         tupel number of the current element. Moreover, it must be allocated to the form Work
         Order. This means that the 12th flag of the form vector is set to 1, representing a bit value
         of 1024. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2013.
     •   2048: muntin doc., tnr>0, man.generated
         ...
         muntin Paper. This means that the 11th flag of the form vector is set to 1, representing a
         bit value of 2048. Field auftxt.generiert is 0.
         If not customized already, the text is adopted with text type number 2014.



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                       112
    •   8192: Production       , tnr>0, man.generated
        The text is found in table auftxt with the keys kpos.poskotxtnr and kpos.arttxtnr plus the
        tupel number of the current element. Moreover, it must be allocated to the form
        Production Paper. This means that the 9th flag of the form vector is set to 1, representing
    ...
    •   4096: Purchase        , tnr>0, man.generated
        ...
        If not customized already, the text is adopted with text type number 2016.
Note:
The standard, tupel-based text is adopted for the elements which are relevant for import (e.g. not
for gas or sealants).
Exception:
For muntins, just one element is imported representing the muntin pattern. The text for all
muntin articles provided in the BOM for this grid will be imported however.
...
2.10.           Internal client separation
                        Company change in the order after transfer to AWP
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      113
Export Service
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          114
2.11.           A+W Processing Types
                        UV protection (awtyp 1650)
...
(e.g. shape 75 with 1 AWE edge but 8 CAD segments). With such a constellation, previously only
...
See AWDesk #454284.
                        ...
                        Configure/non-configured processing parameters
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      115
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       116
...
transferred in the OrderXML file under a meta-part.
...
BOM sequence and IP date
With more than one processing ordered, ordered and not-ordered processing may not alternate
on a BOM level. A change causes the next processing ordered after the non-ordered processing to
receive no more IP date.
See also [AW-138807].
...
ITEMS4ALCIM_SETTINGS/SUPPRESS_PROCESSING_PARAMETERS must be assigned per
workstation the value 2.
CAUTION: If accessories (atyp 800) are ordered, the part type of the accessory item must be set to
0 (non-glass item) in AWP.
See also AWDesk #453321, #451780, #438718




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                    117
2.14.    DB switch - Status feedback / rack feedback
   when switching to a new ERP database (e.g.
   multisite system)
A logic has been implemented in the ERP web service with which orders can be reported back to
either an old system or the new system during the conversion phase to a new ERP database. This
logic is only available for status feedback (order and rack-related). The logic does not work for
import and rescheduling. Orders from old systems may therefore no longer be changed during the
conversion phase.
In the configured standard database, the ERP Web service checks the table AWC_DBSWITCH.
Other possible database connections and the corresponding order number ranges can be entered
there. If the ERP Web service does not find an entry in table AWC_DBSWITCH for the number
range of the current order number, the status message returns the standard DB.
The logic is enabled by setting the environment variable AWC_DBSWITCH ="ON". The variable
cannot be activated site-specifically. It is set cross-site for the new system.


The table AWC_DBSWITCH has the following structure:
 Field type            Field type     Field type Description
 Description           Description
 minauftrnr integer    minauftrnr     minauftrnr integer Minimum order number of the
 Minimum order         integer        number range of the DB connection stored here
 number of the         Minimum
 number range of       order
 the DB connection     number of
 stored here           the number
                       range of the
                       DB
                       connection
                       stored here
 maxauftrnr integer    maxauftrnr     maxauftrnr integer Maximum order number of the
 Maximum order         integer        number range of the DB connection stored here
 ...
 stored here           the number
                       ...
                       connection
                       stored here
 dbserver              char(40)       DB-Server
 dbname                char(40)       DB-Name
 dbuser                char(40)       DB-User
 clientlocale          char(30)       Client Locale



A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                   118
 dblocale               char(30)         DB Locale
 site                   smallint         Hausnummer


The table must be filled manually using insert statements. Theoretically, several entries for one
and the same site are conceivable, but all order number ranges specified must be disjunct.A
maintenance dialog is not available.
A password for the database connection is not stored in AWC_DBSWITCH. The password for the
databases stored in table AWC_DBSWITCH is taken from the standard connection data stored in
A+W Production. The passwords for the database user must therefore be identical on the
standard database and the databases entered in the table AWC_DBSWITCH.


Some special features apply to the rack status report:
For all order numbers assigned to the rack via the lites, the system checks whether a record exists
in AWC_DBSWITCH in which MAXAUFTRNR is greater than and MINAUFTRNR is less than the
transferred order number. If a record exists and it is the same for all orders on the rack, the DB
connection stored in this record is copied and the rack booking is executed.
The customer must ensure that racks are booked separately for old and new orders. A rack is
reported back to the client to which all orders are assigned.
If a rack nevertheless contains lites that are assigned to orders from an old system and the new
system, a special logic applies:
The system checks whether a rack contains lites for different orders with different site/db
assignment. In this case, the rack booking is rejected. An info mail will be sent. The recipient of
the e-mail is determined site-exactly from the env variable AWC_RACKSTOCK_MAIL_MANR.
Attention: AWC_RACKSTOCK_MAIL_MANR must be configured in the current standard database.
This means in the database, which is also entered in the configuration of the AWP for the
feedback.
In the mail the user is informed that the rack booking for the rack xy was rejected and the
databases between which the conflict existed are also indicated.
An error message is also generated in the ERP Web service log. The system logs that the rack
booking for rack xy has been rejected. In addition, the orders assigned to the lites and their
database affiliation are listed.
The rack assignment in A+W Production can be corrected on the basis of the info mail. The rack
booking can then be triggered again by reassigning the corrected rack to an appropriate
registration point.


Note about POs in the ERP old system:
In the old system, POs can still be generated from existing PO suggestions.
Inward goods can be entered for existing POs.


Restrictions:
As already described above, orders from old systems can no longer be changed, since
rescheduling cannot be confirmed.



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                           119
You cannot confirm shifts of orders from old systems in shipping either. The old orders must be
processed in the old system (shipping).
The following applies to racks: The customer ensures that racks are booked separately for old
and new orders.


See also AWDesk #415937.
...
provide answers to frequently asked questions.
                         ...
                         Error reports in the Windows service log
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        120
...
can decide this based on the relevant bits in the form vector.
         ...
         Muntins                                           11                00000000001000
         Purchase order                                    10                00000000010000
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         121
         Character                                       Can be represented by
         ’                                               &apos;
         Line break                                      &#xD;&#xA
...
change of order, the information in the resulting OrderXML files will not always match.
                         ...
                         Processing step assembly or cutting
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                            122
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                    123
...
off.
If the supply type of this article is Production, the laminated glass product is imported together
...
order search.
Since every re-initializing of the database requires memory however, the re-initializing attempts
are limited now in case of a lengthy loss of connection:
    •   If database initialization fails, the service will wait two minutes before attempting
        initialization again.
    •   If initialization fails five times in a row, the service is terminated and troubleshooting must
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        124
...
database. Even if all this fails, the program assumes that there is an error, and the service stops.
                         ...
                         Glass door systems and shape data
...
OrderXML service is installed. (#314985).
                         ...
                         Weight of main and sub parts
See also AWDesk #422884.




A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         125
History

The weight transfer for BOM elements in OrderXML was originally developed in 2009 for
statistical purposes.
Since then, customers have consistently reported that the weights transferred to AWP are not
correct in some cases.
In AWDesk #422884, it was described in detail how the problem occurs, and a solution was
implemented to contain it.
Problem description:
Both for transport processing (truck loading) and for internal logistics (handling of the sheets),
correct weights are essential. If here you are working with incorrect or imprecise weights, this can
have serious consequences for the company. (overloaded truck, machine overload, violation of
safety provisions, etc.)
We have had complaints from customers that the weight calculations both in AWE and in AWP do
not provide a correct weight in individual cases.
    •   In AWE, there is a correct calculation of the area for shapes for main parts, but no
        calculation of the circumscribing rectangle. The transfer is done in the OrderXML file in
        the <PRODUCT> element in the "weight" attribute. In the attribute, AWP expect the
        weight of the circumscribed rectangle.
    •   In AWE, there is no correct calculation of the area for shapes for sub-parts and thus no
        correct weight for shaped sheets.
    •   All shape weight calculations in AWE are done based on area/quantity formulas (stored by
        the customers themselves?). The precision of the results therefore depends on the quality
        of the stored formulas.
        It happens again and again that for a shape with unusual dimensions, the shape weight
        calculated in AWE deviates very sharply from the actual weight.
        See also PF [AW-101928].

Solution:
In the OrderXML file, starting at a defined version, the unique attributes "weightShape" and
"weightRectangular" will be transferred. From the attribute names, it is possible to distinguish
whether the weight transferred is the shape weight or the weight of the circumscribing rectangle.
If one of the attributes is not transferred, it is possible to decide in AWP whether the weight
should be calculated after the fact.
...
Previously (up to content OrderXML version < 5.5.0002) the element "weight" was filled for each
<PRODUCT> element. This means that the weight is determined for each part and transferred to
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        126
...
All have the assumed density of 2.5g/cm³.
                        ...
                        Ordering types and their significance
The following order types are used in the AWE environment:
    •   Produce
            o   Used for order transfer.
    •   ChangeProduce
            o   Used on the item level with MODUL_PROD_SPAETE_AENDERUNG if items are
                already locked but individual values should be updated in AWP via update.
                Kpos.aendkz=4



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        127
   •   NoChange
           o    Used on the item level with MODUL_PROD_SPAETE_AENDERUNG if items are
                already locked, other items were changed, but these were not. Kpos.aendkz=0
   •   Cancel
           o    Used for user cancellations from AWE.
           o    In case of client change in a multi-site, the cancellation is sent to the AWP of the
                previous client via export service via a PPT-WS call. Here, the front end waits for a
                response directly before saving the client change
   •   Offer
           o    For ORDERXML=2, quotations are also transferred to AWP. The OrderingType
                Offer is used for this.
   •   Calculation
           o    Used for a cost calculation call from AWE for orders. This serves generally to
                determine a precise contribution margin before release including wage and
                machine costs.
   •   OfferCalculation
           o    Used for the transfer of a quotation to cost calculation. For this, the variable
                ORDERXML_OFFER_CALCULATION must be activated.
   •   Reservation
           o    Used for order transfer for orders with kaufart = 3 Reservation
   •   CostBasedProduction
           o    See AW -126899 - transfer to cost calculation with subsequent determination of
                the contribution margin. The order is retained in AWP and can, without new
                import, be released again after positive DB check.
   •   Not in use in the AWE environment:
           o    Change
           o    Changing
           o    ChangeOffer
           o    DeliveryDateCheck
           o    DeliveryDateCheckOffer
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                       128
...
information awProcessing. Apart from type ID and quantity, this includes the category and the
relevant parameters according to the processing type.
For every processing type, the following table describes lists the category and processing
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      129
...
found directly in awProcessing. The following picture shows an example for coating (processing
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                     130
A+W Software GmbH   EN-CONFIG-A+W Enterprise Production Interface.docx   131
3. AWP Connection
3.1. Overview
                       Motivation and goals of this development
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                    132
...
web service the ALCIB functionality.
                       ...
                       Process description of the connection
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                       133
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        134
    •   Updating the order
...
text will be booked (available in 2011 and 2012 from SP3 ).


                         Calculation of dates for the receipt of goods
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      135
...
Today Thursday July 8, 2010, delivery time 4 days
       Result Wednesday July 14, 2010, as it is the weekend from July 10 to July 11 and the
           weekend is usually not one of the trading days.
...
evaluated. The dimensions of the purchased parts are not taken from the order in the ALCIB, but
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      136
...
and the P.O. numbers have changed, the behavior has now been changed (Webservice
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       137
...
the ERP web service).
Expansion of the Bestwun locking logic with BEST_LOCK_TEST (only up to Version AWE 5,
starting with AWE 6, the logic is standard)
...
Attention: If the env variable MODUL_PROD_SPAETE_AENDERUNGEN is active ("ON"), (status as
of 08/28/2023) free bestwun/bestpool records are NOT updated with lockmanr= -100!
See also PF [AW-154845].
...
change of the order.
Attention: The env variable BEST_LOCK_TEST_SPERRE is (status as of 08/28/2023) output in the
ERP Webservice log, but it is NOT evaluated in the ERP Webservice order logic. In case of existing
locks records are ALWAYS written to the table awc_lock_bestwun, regardless of whether or not
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        138
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                         139
...
prerequisite: ALCIB 2011, Build number 2893


Rotation for purchasing
...
See also PF [AW-194581].


                        Cost calculation - General
The personnel and machine costs are calculated exactly in the AWP and are returned to the AWE
after successful scheduling or rescheduling. In AWE, the cost calculation is updated by deleting all
existing personnel and machine costs (that were not created manually) from 'poskost' and
creating the new records.



A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                     140
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                          141
                        Cost calculation - logical and physical machines
See also PF [AW-142005].
In case of reporting of the cost calculation (CompleteScheduling), the AWP transfers the
determined "machine costs" and "personnel costs" in cost elements.
Cost elements are BOM elements in which personal and/or machine costs are stored. A physical
and a logical machine can be specified in a cost element.




Cost records in AWE
For each cost element transferred by AWP, a poskost record is generated by the ERP Webservice.
The ID of the physical machine is stored in the element <PhysMachine>. It is written to
poskost.bmnr.
The ID of the logical machine is stored in the element <RealMachine>. It is written to
poskost.psbmnr.


Machine master data in AWE
For each physical and logical machine that occures in the cost elements, a master data record
with ID and designation is generated in AWE or the designation is updated if the record already
exists.


Table pmsbm
The physical machines are stored in the table pmsbm.
The ID from the element <PhysMachine> is stored in the field pmsbm.bmnr.
The description from the element <PhysMachineDescription> is saved in the field pmsbm.bmbez.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                   142
The logical machines are stored in the table pmspsbm and are assigned to a physical machine
there.
Various logical machines can exist for a physical machine.
The phys.ID from the element <PhysMachine> is stored in the field pmsbm.bmnr.
The logi.ID from the element <RealMachine> is stored in the field pmspsbm.psbmnr.
The description from the element <RealMachineDescription> is saved in the field
pmsbm.pmsbmbez.
...
for which the stock change code
    ...
    •   AWP,
    •   delivery note/AWP (only for BOM elements,) , or


    •   manual/AWP (only for BOM elements)
...
If from AWP no data is transferred for the corresponding tuple and there is a formula for the
current BOM, then the dimensions are determined from posbemass and in case of linear meters
and cm, converted into mm for synchronization with the data that comes from AWP.
At the end of the calculation, the result is converted back into this quantity unit depending on the
quantity unit of the article. Attention: starting with ERP-WS version 13.04.7828 (11/15/2022),
there was no conversion, hereby no more conversion from mm to linear meters. This has now
been corrected again with version 13.04.8275.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                     143
Special treatment of particular Atypes (status as of 07/17/2023)
    •   Spacer (210, 211)
        Here the data from AWP is always used. The thickness of the frame is deducted from the
        article master via the returned frame geometry per step difference calculation via the
        alrpc The resulting width and height are then multiplied as described below.
    •   Muntins (230)
        Since here only the circumscribing rectangle of the muntin grid is reported back from the
        AWP, the value from mass1 is now always used from the table posbemass. It contains the
        linear meters taking into consideration omitted muntins. In addition, the value Anz1 is set
        to 1 and Anz2 to 0.
...
Here, the parent relationship upward in the BOM is examined to see whether there are Anz1 or
Anz values > 1. The quantities are thus multiplied in each case.
The final quantities are determined via the alrpc, however. Here, it is multiplied by the item
quantity and the correction factor from the master data is also calculated in. (Variable
PMLAGERVERLUST)
The inventory number is usually determined by means of article master data. There are additional
configuration options.
For main articles taken from stock, the stock variant comes directly from item data. A customized
...
Inventory check on import / scheduling [AW-72192] / rescheduling [AW-127570]

Via the switch AWC_CHECK_STOCK, a stock check can be configured when
scheduling released orders. Here, for all stock articles that are set to inventory
change flag "AWP" in the A+W Enterprise article master data, a forecast up to the
production start date in question of the (intermediate) product is made. This check
is also carried out with the appropriate rescheduling. With QR2302, it is possible to
configure that the inventory check is no longer done in case of a rescheduling. For
this, the "reporting type" in A+W Production is set to 1.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      144
If there is not enough quantity in the standard stock stored in the A+W Enterprise
article master data (alternatively, the stock is determined via the switch
WL_GET_STDLAGER_SP), then:

   • the order will be written in A+W Production in the "red card" rubric
     "reporting problems".
   • the order will be placed in A+W Enterprise in the status "error during
     scheduling".
   •   the system e-mail ID 93 will be sent to the employee stored in the order and/or in the
       mail system. If the employee's DB access doesn't work, there is an attempt to send the
       mail to the employee -1.

During the check whether there is enough stock, the following steps are carried
out:

   1. per article, stock, variant, color, and date, the required quantities of all
      items of the order are added up and checked.
   2. If the combination article, stock, variant, color is required on different days
      (e.g. IGU with structure "4mm float" + "4mm float" in LAMI), then the
      quantity of the first production start date is also considered during the
      check for the second production start date. That is, in the case described
      above, the 4 sqm float is required for the LAMI on 12/14 and 2 sqm for the



A+W Software GmbH      EN-CONFIG-A+W Enterprise Production Interface.docx                 145
       float directly on the IGU on 12/15. Then the inventory check would check
       first 4 sqm on 12/14 and after that, 6 sqm on 12/15. This is necessary since
       the order's data at this time is not yet saved in the forecast table wlppms.
    3. Articles with the quantity units length, linear meters, kilograms, and volume
       are checked via the variant variable.
    4. Since for QM articles (glass) there is no variant information in the BOM, the
       check is done across variants on the article level with variant=0.

The functionality is executed in the reporting in the ERP WebService.

During the OrderXML transfer, not all BOM elements are transferred to A+W
Production. Thus, the stock sizes are not known there, for example. This is why the
logic searches in A+W Enterprise starting from the stock part in the A+W
Enterprise BOM via the respective parent articles upward, until a BOM element is
found in the A+W Production report. For this BOM element, the error flag is
reported back to A+W Production.

CAUTION: The field pms_tnrmvater in the table wlppms is now no longer assigned
the parent of the noted tuple, but instead the associated tuple from the AWP
transfer.

    • CAUTION: The field pms_tnrmvater in the table wlppms is now no longer
      assigned the parent of the noted tuple, but instead the associated tuple
      from the AWP transfer. This can be the tuple itself, it can be the parent or
      grandparent, etc.
    • If there is a SP cu_pmewlagbitnr, the effect of this can be that unexpected
      variants (bitnr) are written to wlppms and are incorporated into the stock
      forecast.
...
Since not always all articles that have a state change AWP or */AWP, in case of stock shortfall,
should cause that an import of the order into AWP is not possible, this check is now done
depending on a configurable field. To activate this check for an article, the field "AWPStockCheck"
must be configured in the master data and in case of the corresponding articles, set to the value
1. If this field does not exist or it demonstrates a value that does not equal 1, there is no check.
However, the article is written to the forecast table (wlppms).
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      146
...
Changes to the stock forecast in version 6 QR11
        Date           PF ticket       Comment
        2021-11-25     [AW-72192]      Checking the inventory during scheduling




Changes to the stock forecast in version 6 QR2302
        Date           PF ticket        Comment
        2023-02-10     [AW-127570]      No check of the stock during rescheduling.
                       7828-04-13       A+W Production and A+W Production
                                        Import are also required.
...
intauf. Min. prerequisite: ALCIB 2011, Build number 2893
                        ...
                        Stock removal - reporting of stock plates (XTV)
The control in AWP for reporting stockplates is done precisely to the machine. It is described in
the configuration instructions EN-CONFIG-A+W Production.docx chapter Reporting of stockplates.
In AWE, the following steps are performed via the ERP WebService (function
SetStockplateBooking):
    •   There is a check whether the stockplate has already been booked (table pmyoptlm with
        xopeinr=jobid lfdnr=lfdnr plattennr=stockplatenumber)
    •   Before each booking, the article number of the stockplate reported is checked. The article
        number has to be known in ALCIB article master data. For a fixed glass size (this is possible
        because in ALCIM, glass types are defined by the same numbers as the cut glass by



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      147
        default), an appropriate BOM has to be defined in ALCIB master data (access to strukt
        with key vater=<transferred article number> children with a stock size article type),
        consisting of a stock size and cutting. In this case, stock withdrawal will be made for the
        corresponding stock size article; otherwise, the booking is made by the reported article
        number.
    •   If such an article is found, the booking is done via the alrpc and then via the stock booker
        with status 68 (PMS_ABGANG_EXT). Here, via the SP wlgetbitnr (wlgetbitnr($wlhp->artnr,
        $sSPMeh, $wlhp->mass1, $wlhp->mass2) ) due to the dimension variants it is checked
        which Bitnr should be booked of whether this may be a residual plate that may not be
        booked. This distinction is made using the Bitnr returned. If this value > 0, then this is a
        Bitnr that is used for a removal booking. With bitnr = 0, the booking is ignored since it is
        either a residual plate or the article should not be booked.
    •   Determination of the booking stock:
        Currently, the ERP-WS always reports Lnr=0 to the alrpc. It forwards the stock number 0
        (wlh.hausnr = house number with which alrpc runs) to the stock booker. In the stock
        booker, the stock number is determined via the Sharedmemory, if necessary, site and
        variant-specifically.
        If the variable WL_GET_STDLAGER_SP is set, the SP it contains (with the parameters artnr,
        bitnr, farbnr, aufnr, vorgang, posnr, tnr, kopfartnr – the order-related parameters are not
        filled during this call, however) are called. The SP must return the stock number. It is then
        used instead of the stock number from the SHM.
    •   After that, a reservation resolution can be made, see EN-Config-A+W Enterprise chapter
        Resolving reservations
    •   Withdrawal of the stockplate is recorded in table pmyoptlm , together with the stockplate
        codes: job number in the field xoptinr, optimization batch number in the field lfdnr, and
        plate number in the field plattennr. The entry includes the date. When another report is
        made for this stockplate, this entry will be used to prove that stock withdrawal has
        already taken place. This helps to avoid double booking. When does this record become
        invalid, and when will a new plate reported with the same codes due to the sequence of
        numbers? The ALCIB switch PMXTVRLOESCHOPT has to be enabled for this purpose;
        define the number of days after which the entry in pmyoptlm will become invalid. If this
        setting is missing, the records in pmyoptlm will become invalid after 30 days. This means:
        when the Webservice checks if a certain stockplate has already been withdrawn from
        stock and finds in this table a record older than the defined number of days, another
        stock withdrawal will be made.


               Resolving reservations in the warehouse forecast for XTV
             feedbacks
For XTV feedback via the ERP web service, the corresponding reservations are now resolved in the
stock forecast. The system checks the procurement type for confirmed fixed dimensions. For
procurement type "Stock", the reservation for the confirmed fixed dimension is canceled. For all
other procurement types, the lower stock size is determined. If it is found and has the
procurement type "stock", the reservation for the stock size is canceled. If no stock size is found
or none with procurement type "stock", the system attempts to cancel the reservation for the
fixed dimension.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       148
In A+W Enterprise, the corresponding reservations are now also resolved in the stock forecast
when a completion report from production is reported back.
...
(wlppms.b_anz), the status (wlppms.status) is set to 1 ("partially booked"). When the booked
quantity has reached the value of the expected quantity, the status is set to 2 ("completely
booked").
...
In comparison to this, here are two examples for adjusting the stock forecast regardless of the
XTV report:
...
With use of the ERP Stock Service, previously the XTV reporting had to be deactivated since
otherwise removals from coupled stocks were made twice. As a result, the adjustment of the
forecast data coupled to it was also deactivated.

The XTV reporting - and thus the adjustment of the forecast data - can now be used together with
the Stock Service - for the stock booker now checks the stock properties for removals with status
68 (PMS_ABGANG_EXT). If the stock from which the removal should be made is a portal stock
(wlraum.interface = 2), no stock removal is made. In this case, the stock in question is a
synchronized third-party stock that is removed by the Stock Service. A corresponding entry in the
stock booker log documents that this removal is suppressed. The record is then deleted from the
table wlh.

A+W Enterprise

New environment variable for A+W Enterprise "WL_WLPPMS_ADAT_SHIFT". This variable is filled
with a numeric value if you want to increase the starting date for selecting the stock forecast data
from table wlppms (Stock > Information System > Forecast) by 1 or more days. The selection of
the data from wlppms is selected with wlppms.a_datum >= today. Now the selection can be
shifted with the value from the variable into the past. (wlppms.a_datum >= today - value from
WL_WLPPMS_ADAT_SHIFT)
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        149
                   Consideration of item splits when the successful
...
split items are combined again, depending on the type of split:
    ...
    •   Implicit processings: During scheduling, processings can be added implicitly (such as
        ...
        SPLIT_POSKOST_COSTS is set, the costs of these processings are processed individually.
                          ...
                          Status confirmations production
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                     150
...
In AWP, a status that should be reported, is noted in the table ERP_RUECKMELDUNG.
...
Status overview in A+W Produktion and A+W Enterprise
The following table shows the statuses in A+W Production (AWP), the status updated in the A+W
Enterprise (AWE) in the kposstat table and describes the effects of the AWE switches using the
example: AWC_FIXIERT_AB=552 and AWC_FREIGEGEBEN_AB=554.
 Action            Status            Status               Remark
                   A+W               A+W
                   Production        Enterprise
 Scheduled         0                 551                  After scheduling, rescheduling or
                                                          change of supply type.
 Create            10                Can be               The status is reduced if a batch has
 bucket                              configured in        already been created.
                                     AWP if 551 or
                                     552 (see
                                     below)*1
 Create            100               552                  If AWC_FIXIERT_AB =552, status
 batch                                                    300 is also entered in kposstat. In
                                                          the order display in AWE, the item
                                                          is marked red, fixed and in local
                                                          correction. This status can be
                                                          canceled by batch resolution.
 Detailed          150               553
 scheduling
 of a batch
 Release           200               554                  If AWC_FREIGEGEBEN_AB =554,
 batch                                                    status 302 is also entered in
                                                          kposstat. The item is marked red in
                                                          the order display, as released and
                                                          in local correction. This status can
                                                          no longer be reversed by a batch
                                                          resolution.
 Barcoding -       700               556                  AWP reports the total actual
 Completion                                               quantity. AWE books the status
 report                                                   and the difference quantity in



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                   151
 Action           Status           Status              Remark
                  A+W              A+W
                  Production       Enterprise
 Scheduled        0                551                 After scheduling, rescheduling or
                                                       change of supply type.
                                                       kposstat: If the first time 4 was
                                                       reported and AWP now reports 10,
                                                       the system books in kposstat
                                                       quantity 6; 10 pieces are displayed
                                                       in the AWE order display as
                                                       finished.
 Barcoding -      800              557                 Here, too, AWP reports the total
 Packed                                                actual quantity. AWE books the
 message                                               status and the difference quantity
                                                       in kposstat

      *1: Configuration of status feedback at batch creation:




                        Status feedback racks
The ALCIM only reports information regarding shipping racks back to the ALCIB (ERP WS method
SetRackInfo). Depending on the configuration, these rack feedbacks are passed on to the normal
rack system (GESTELL_BDE or MODUL_STAPELLOGIC) and/or to the Korean rack system
(AWC_GESTZU_BUCHEN). The table 'bcbock' is always filled. It is assumed that the rack number
received from ALCIM is a number. Alphanumeric rack numbers lead to errors in the ERP web




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                 152
service. The rack number may have a maximum of eight digits. For larger numbers, only the last
eight digits are transferred to the ERP system.
The label number is only imported completely if it has a maximum of nine digits. For larger
numbers or an alphanumeric muntincode, the last nine digits are written into the 'bcbock'.
The rack feedbacks are also snapshots. All lites are always returned to a rack. Booking to 'bcbock'
means, all existing entries for the rack are deleted first and then the complete content of the rack
is entered again.
The data is stored temporarily in AWP in the table ERP_GEST_MELDUNG. If there is no data
about the rack there or no send time is entered, the cause must be sought in AWP.
    •     MELDEZEIT: Time stamp when the report was generated
    •     SENDEZEIT: Time stamp when the report was transferred successfully to the ERP
          WebService
 ...
 Quantity                                  awmuntin_teile.menge
 Auftrnr                                   awmuntin_teile.auftnr (similar to kauf.auftrnr)
 Bmnr                                      awmuntin_stellen.maschinennr
 Date                                      awmuntin_teile.letztebuchung
 Etinr                                     awmuntin_teile.etikettnr
 Gnr                                       awmuntin_teile.gestell; (must be numeric!)
 Posnr                                     pool_pos.pos_referenz (the first three digits, similar to
                                           kpos.posnr)
 Time                                      awmuntin_teile.letztebuchung
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                      153
 Action             Status     Status    Comment
 ...
 Entry              0          1         A rack receipt was booked.
                                         ...
                                         Booking rack shipping (table gest/gestzu
                                         AWC_GESTZU_BUCHEN) - ERPWS - alrpc - rserv status
                                         21
 ...
 Packed             900        3         The rack was packed
                                         ...
                                         AWC_GESTZU_BUCHEN) - ERPWS - alrpc - rserv status
                                         19 + 20
 Shipping           950        4         The rack was booked to shipping
                                         Booking BCBOCK ERPWS directly
...
A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                   154
    • Ftest from alrpc
...
switch must be set if ALCIM cannot guarantee that only numerical rack muntin codes are used. It
can also be set to prevent unnecessary bookings in table bcbock.
...
servers. For a detailed description, see the AWE configuration instructions.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      155
                        Provision of cost centers
...
selects the fields kostenst and bez from table kstelle and returns them.
                    ...
                    Treatment of orders with high priority (AWDesk
              #447496)
...
(scheduling in AWP).
                    ...
                    AWP transfer cost calculation + reservation - [AW-
              126899]
In the OrderXML transfer, the new transfer type (ottranszus.typ) 128 is evaluated.
With this transfer type, a reservation in AWP is made in addition to the cost calculation. With this
logic, the performance of the scheduling should be improved, since for the release of the order in
AWP the order no longer has to be scheduled again via the OrderXML; instead, the release is
handled via the Export Service and a PPS Webservice call.
The logic is activated in AWE via the env variable AWC_CHECK_MARGIN. If the OrderXML service
finds the value 128 in the field ottranszus.typ for an order, the order is provided in OrderXML with
the new OrderingTypeType "CostBasedProduction", so that in AWP, in addition to the cost
calculation, there is also a production reservation.
The value ottranszus.typ = 128 is generally expected for the order, that is, in the ottranszus
record, posnr = 0 and tnr = 0.
The logic conly has additional effects if, after the cost calculation in AWP, the checking of the
marginal income in AWE (intauf) is positive. In this case, a transfer record is written to the order
with exportinfo.schnittstelle "PRODRELEASE" in the table exportinfo. The AWE Export Service
processes this record and calls the PPS Webservice method PublishTemporaryOrder() in order to
initiate the release in AWP.
Afterwords, AWP reports a complete scheduling to AWE in order to transfer the current order
data.




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      156
If the check of the marginal income in AWE (intauf) is negative, no release can be made via the
AWE Export Service. The production release iis then done in the conventional way with another
OrderXML transfer.
Caution: Any order cancellation after "cost calculation + reservation" is always done via the
OrderXML service. A cancellation via the AWE Export Service with exportinfo.schnittstelle
"CANCELORDER" is not provided.
s.a. „EN-CONFIG-A+W Enterprise System”



                        Forced errors
It is now possible to generate artificial errors for test or demonstration purposes on purpose. For
this, an article must bear a particular name of the type "Part" in the BOM. Thus, the order will
always encounter the scheduling error 600 (PERRCAPA_UNDEFINED).
For an order error, an article name must begin with "Capa Error" or "Capa Error Order" and for an
item error "Capa Error Item".
Capitalization is irrelevant. Articles of the type processings are not considered,
Albwir.Alcim.Orders4Production.dll - v13.6.5725
Diskset: A+W Production 6 Import - v13.6.5725
Diskset: A+W Planning 6 Import Services - v13.6.9341


                        Transfer of purchase information to AWP
This happens with appropriate configuration after renewed transfer of an order to AWP by the
rserv.
See EN-Config-A+W Enterprise Export Service.doc chapter BESTINFOALCIM.


                        Reporting of an element exchange
[AW-221950] / 04/2025
alcib - 13.04.20016
A+W ERP Web Service 6 -13.4.9751
For companies with several IG lines, sometimes the constellation arises that the line specifies the
spacer (e.g. TPS or ALU). However, this is not known in the AWE BOM, thus here incorrect
material costs are used for calculation and the stock forecast does not use the correct article. For
this reason, an existing spacers can be replaced by another via a stored procedure on reporting
from production. Here, the spacer to be replaced and the new one must have the same thickness
or color variants and they must have the procurement type stock.
The SP cu_getspacerarticle(aktHausnr, artnr, realMachine, physMachine) decides whether or not
a spacer exchange should be made. As parameter, the SP contains the company number of the
assigned client, the article number of the frame article from the AWE BOM, the logical and
physical tools of the processing IG production (Atyp 530), which was reported by AWP.This SP




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      157
returns the spacer to be exchanged, otherwise 0. The ERPWS then forwards this exchange to the
intauf (here then an entry is written in the table zuaufint with art=-52).
If an exchange of a spacer is reported via the ERPWS, the order is processed via a chain of follow-
up processings by the background process intauf. The exchange data is written to the additional
table (zuaufint).Directly after the cost calculation (still =-10), there is a check whether the data for
the exchange is present. If so, there is a processing with still=-52 (element exchange), and directly
after this also processing with still= -38, via which the costs are calculated and the stock data
adjusted.
If an exchange is not reported for all items of the identical BOM, then a new BOM is assigned for
the items with the exchange. For triple IG, the exchange is considered for both spacers. However,
it is expected that either both or none should be exchanged. Currently, the logic is only set up for
2 different spacers. So the case where, with the originally identical BOM in the position X, spacer
A should be replaced with spacer B and in the position Y spacer A should be replaced with spacer
C is not supported.
Caution: The structure of the exchanged article must be identical, both with regard to the BOM
structure and the definition of the additional data (article dimensioning, variant definition, color
definition). The concern of the statement is that an "identical" poszu record must exist both for
the source article as well as for the target article. If you were to enter the source article and target
article manually in the order, the corresponding poszu records must be identical (but for the
article number, article name, quantity, etc). In addition, the complexity of this function is limited,
especially with regard to triple IG.
The precise requirement and complexity must be tested in each case by the customer on-site. In
particular, with regard to the topic "exchange"/"no exchange"/"other exchange" with originally
identical BOMs.
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        158
                        awc_modparams
...
The storage of the report object from AWP during CompleteScheduling can be configured for
research purposes. The report object includes all data reported by AWP for an order in the xml
structure.
...
To be able to allocate the AWE item number and tupel number in the report object, the following
relationship applies:
AWE posnr = <*Item>.<Item> / 1000 (Division -> the first digits)
AWE tnr = <*Item><BomItems>.<*BomItem>.<BomReference> % 10000 (Modulo! -> the last
digits)
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        159
                   AWC_MIN_HZEIT_KUNDE
              (PMEDASCHMINHZEITKUND)
...
stored for the route, this variable is evaluated.
                         ...
                         AWC_BESTELLEN_BIS (PMEHEUTEBZEIT)
...
placed. If the variable is not set, it is assumed that orders can be placed until the end of the day.
                         ...
                         AWC_FIXIERT_AB (similar to PMXCIMRMSTATI)
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        160
                         AWC_URL_PRODUKTIONSBERICHT
...
ALCIM.
                         ...
                         AWC_GESTZU_BUCHEN_OHNE_VERPACKTMELDU
              NG
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        161
                        AWC_PORT_RPC_DIENST
...
numerical rack muntin codes are used. It can also be set to prevent unnecessary bookings in table
bcbock.
If the switch is ON and active, neither the table bcbock will be filled, nor will bookings be made
that are enabled by the switches GESTELL_BDE, MODUL_STAPELLOGIK, or
AWC_GESTZU_BUCHEN. (#229434)
...
initiator of the mail must be defined with it. This employee is then informed by default if an order
date has changed, which could not be written back into the order suggestion. Alternatively, using



A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      162
the mail ID 33, an alternative group of recipients can be defined. (required in 2011 and 2012
...
Variable is no longer evaluated. See AWDesk #335280.
...
longer communicated to purchasing. The POs thus remain unchanged.
...
recommended from A+W Production 5. In the following, first the switches for the functioning of
the logic are described, but then also the switches which are also important in the interaction
AWE-AWP.
All switches can be set via the AWP configuration dialog (menu item Master Data >
Configuration).




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      163
                        Switch for loading OrderXML files.
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       164
This switch can only be set globally.
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        165
                   Additional                 AWP          switches           for      AWE-AWP
              communication
The following parameters should also be checked and set when setting up AWE-AWP
communication. They influence the data that is reported to AWE (for example, for purchase order
parts).
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                           166
...
dimension correction.
                        ...
                        PF tickets with AWP configuration problem
[AW-113462] - Reporting of the processed processing parameters
Here, problems occurred with the mirroring of lites ordered. The solution was to assign the AWP
switch "Reporting of the processed processing parameters" the value "2".


3.7. System messages
                        Status 73 - Scheduling or rescheduling failed

                        Status 74 - Postponement of delivery date

                     Status 43 - A broken product contains purchase
              order parts which have to be reordered




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      167
3.8. Logging
                   Report (CompleteScheduling) about the ERP
              Webservice
...
In addition, the storage of the report object can be configured for research purposes.See the
separate "Report object" chapter.




3.9. Troubleshooting
                        Grinding allowance missing in the PO feedback
An update to AWP must probably be performed.
See PF [AW-146391] + [AW-163528].



                        During scheduling, references are not found
"For the order item [x/y], the processing with the reference [z] was not found in the SN file for the
reporting of the processing parameters."
Possible solution
In AWP/SN, the sketch generation must be set to the correct view.
See also PF [AW-146958]


Additional case, cause not explained: PF [AW-174259].


Note 1:
If during OrderXML generation there is already an SN file (from AWE), this file is
changed/manipulated again during import.
For research, it may be necessary under some circumstances to examine the unchanged file.
An SN file is unchanged if the order has not yet been transferred to scheduling (also not to cost
calculation).
It appears to be that the original file is also backed up in the meantime under the name
<filename>.SN.org




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      168
Note 2:
If there is already an SN file in the OrderXML item, the import transfers this SN file and the
OrderXML file to the SN.
The SN then tries to assign the correct reference (combination of AWE posnr and AWE tnr) from
the OrderXML file for each procID in the SN file and to save it in the SN file. On successful
assignment, the AWE tuple number is displayed when opening in the SN in the BOM view next to
the ID.
After that, the import checks whether for all relevant processings (generally these are the
processings for the PO reporting) the corresponding references exist in the SN file. If a reference is
lacking, there is a scheduling error with the infamous message "For the order item ... the
processing with the reference ... was not found in the SN file for the reporting of the processing
parameters."


Note 3:
The references are required if for a PO item the adjusted processing parameters have to be
reported back.
The report of the processing parameters is only done if the configuration is set appropriately in
AWP:
ERP reporting = 2
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                       169
                       Shape change for purchased part
If in the CompleteScheduling there is a shape change for a purchased shaped glass, but there are
no compelling reasons for the shape change, it can be prevened with a switch in the SN.
PreferInitialShapeNumber = 1



                       Crash of the OrderXML Service
Flawed BOMs can in rare cases cause a crash of the OrderXML Service. Here there is an endless
loop in the logic, which in turn causes a memory overflow. In case of the PF ticket [AW-200146],
this is a corrupted muntin with tnr=0. The logic in the OrderXML service will become more robust
over time.It is in any case, first the last hotfix of the OrderXML service must be installed and
tested to see whether the problem occurs again.
See PF [AW-200146].




A+W Software GmbH       EN-CONFIG-A+W Enterprise Production Interface.docx                   170
                     ProcPostThermal processings in der OrderXML
              transfer on the wrong lite
Setting the env variable ORDERXML_POSTPROCTHERMAL_ON_TVG.


                     Order too large for current ERP Webservice
              configuration
Order XY:
[XJMO 10051] error message from the ERP system: There was an exception running the
extensions specified in the config file. ---> System.Web.HttpException: Maximum request length
exceeded.
Or
[XJMO10051]Error message from the ERP system: The operation has timed out.
This means that the order or the report object is too large for the present ERP Webservice
configuration.
Solution:
Configuration in the IIS or directly in the web.config of the ERP Webservice.
Adjust request sizes to 16 MB (16384) or even to 32 MB (32768)
<configuration>
<system.web>
...
If this doesn't help, make the timeout tolerance larger:
<configuration>
<system.web>
...
See AWDesk #378450, PF [AW-229440]




A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                  171
3.10.           Appendix
                Stock forecast in version 2009 and configuration options
...
It has to be specially enabled in Version 2009. Prerequisite are the latest build numbers of ERP
Webservice and of the ALCIB background process alrpc. The table awc_wlppms must exist. This
table contains temporary data for the alrpc background process which makes the booking in table
wlppms. To install this table later, please use the script from the UNIX development servers (e.g.
nipponator) (see case 171284).
Updating the stock forecast date in case of rescheduling is a new feature. Otherwise, the data for
stock forecast are determined in the same as by the former PMS. Quantity calculation does not
permit to analyze BOM formulas. A special loss can be defined via switch PMLAGERVERLUST. If
...
DECIMAL         Thickness of the header part (see external description for determination)
                ...
                Generation of remake purchase orders
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                        172
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                        173
...
A+W Software GmbH         EN-CONFIG-A+W Enterprise Production Interface.docx                      174
Requirements
...
of the function. In already-existing remake items, the necessary marking is missing.
                ...
                Workflow of background processes
...
A+W Software GmbH        EN-CONFIG-A+W Enterprise Production Interface.docx                      175

