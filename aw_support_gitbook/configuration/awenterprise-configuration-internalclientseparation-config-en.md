...
**1. Notes on this Document (Page 6)**

**2. Introduction (Page 7)**
*   2.1. Checklist for the introduction/configuration of a multi-client system (Page 7)

**3. System Configuration (Page 10)**
*   3.1. Server (Page 10)
*   3.2. Number ranges (Page 10)
    *   3.2.1. Site-specific number ranges (MP_SITE_EXACT) (Page 10)
*   3.3. Configuration File (Page 11)
*   3.4. Table xhaus (Page 11)
*   3.5. Directory structure / required files (Page 13)
*   3.6. Call Center // External Order Interface (Page 13)
*   3.7. Scripts (Page 14)
*   3.8. Status reporting (Page 15)
*   3.9. Messages (Page 16)
*   3.10. Environment variables (Page 16)
*   3.11. Error handling (Page 20)
    *   3.11.1. Error with nr_server (Page 20)
    *   3.11.2. PO generation does not start automatically (Page 20)
    *   3.11.3. Incorrect client in the mail subject (Page 20)

**4. Multilingual operation – employees (Beta) (Page 21)**
*   4.1. Introduction (Page 21)
    *   4.1.1. Checklist in start-up (Page 21)
*   4.2. Master data (Page 22)
    *   4.2.1. Tax types (Page 23)
    *   4.2.2. Notes (Page 23)
    *   4.2.3. Article master data (Page 24)
    *   4.2.4. Article dimensioning (Page 24)
    *   4.2.5. Order entry (Page 24)
    *   4.2.6. Site change (Page 24)
    *   4.2.7. System (Page 25)
    *   4.2.8. Output (Page 26)
    *   4.2.9. Research help (Page 27)

**5. A+W Enterprise Master Data (Page 28)**
*   5.1. Master data at the dealer's (Page 28)
*   5.2. Master data at production site (Page 29)
*   5.3. Master data in stock (Page 29)
*   5.4. Companies (MP_SITE_EXACT #333097) (Page 30)
*   5.5. Key (Page 31)
    *   5.5.1. Due date conditions (Page 31)
*   5.6. Product groups (#334944) (Page 33)
*   5.7. Market partner master data (Page 34)
    *   5.7.1. Routes (Page 34)
    *   5.7.2. Limit check (Page 35)
    *   5.7.3. Client-specific data (MODUL_INTERNE_MANDANTENTRENNUNG) (Page 35)
    *   5.7.4. Client assignment MP_SITE_EXACT (#334703) (Page 37)
    *   5.7.5. Company assignment MP_SITE_EXACT (#333097) (Page 39)
*   5.8. Item master data (Page 40)
    *   5.8.1. MP_SITE_EXACT (#331647) (Page 40)
*   5.9. Employees / user rights (Page 41)
    *   5.9.1. MP_SITE_EXACT (#332946) (Page 41)
*   5.10. Client-related company calendar (Page 44)

**6. Texts (Page 45)**

**7. Prices (MP SITE EXACT # 333913) (Page 46)**
*   7.1. Requirements and configuration (Page 46)
    *   7.1.1. System / environment (Page 46)
    *   7.1.2. Employee master data (Page 46)
    *   7.1.3. Market partner master data (Page 46)
    *   7.1.4. Price master data (Page 47)
    *   7.1.5. Terms (Page 48)
    *   7.1.6. Evaluation in document entry (Page 49)

**8. Sales (Page 50)**
*   8.1. Limit check (Page 50)
*   8.2. Transaction data (Page 50)
*   8.3. Client-specific release pool (Page 50)
*   8.4. Order corrections after successful client allocation (Page 50)
*   8.5. Change of client allocation (Page 51)
*   8.6. Company change in the order after transfer to AWP (Page 52)
*   8.7. Reference (Page 53)
    *   8.7.1. Site assignment (Page 53)
*   8.8. Expansion of the automatic invoice creation (Page 54)
*   8.9. New supply type "not available" (Page 54)
*   8.10. Document search via site number (Page 55)
*   8.11. Total surface for objects (Page 55)

**9. Call center solution (Page 56)**
*   9.1. Configuration (Page 56)
*   9.2. Initial version (Page 57)
*   9.3. Manual PU price (Page 58)
*   9.4. Supplier determination after client assignment (Page 58)
*   9.5. Client-specific change of order after successful allocation (Page 59)
*   9.6. Reference to an allocated order (Page 59)
*   9.7. Failed allocation (Page 60)
*   9.8. Total surface for objects (Page 60)

**10. Purchase (Page 61)**
*   10.1. Extension in PO pool (Page 61)
*   10.2. Rack-related incoming goods (Page 61)

**11. Information systems (Page 62)**

**12. PMS / AWP (Page 63)**

**13. Dispatch control (Page 64)**
*   13.1. Interim goal for dispatch (Page 64)

**14. A+W Enterprise - Barcoding (Page 65)**

**15. Replications (Page 66)**
*   15.1. Master data transfer (old master data replication) (Page 66)
*   15.2. Key tables (old key replication) (Page 66)
*   15.3. Item transfer (old item replication) (Page 66)
*   15.4. Table distribution (Page 66)
*   15.5. External Market Partner Interface (Page 66)
*   15.6. External EDI (Page 67)

**16. Corporation Statistics (Page 68)**

**17. FinAc data (Page 69)**
*   17.1. Transaction data for financial accounting (Page 69)
*   17.2. Internal charging (Page 69)
*   17.3. FinAc transfer of debtor data (Page 69)
*   17.4. Vendors (Page 70)
*   17.5. FinAc totals (Page 70)
*   17.6. Transfer of cost centers (Page 70)

**18. Message transfer (Page 71)**
*   18.1. System message distribution (Page 71)

**19. Construction site invoicing (Page 72)**

**20. Racks (Page 73)**
*   20.1. Rack transfer (Page 73)
*   20.2. Rack (block transfer) (Page 73)
*   20.3. Rack comparison (Page 73)
*   20.4. Rack distribution (Page 73)

**21. Project Information (Page 74)**

**22. Distinction (Production - Distribution) (Page 75)**

**23. Barcode Data (Page 76)**

**24. Via plant / ViaPlant (Page 77)**
*   24.1. Master Data (Page 78)
    *   24.1.1. Reg. No (Page 78)
    *   24.1.2. Route maintenance in master data (Page 78)
    *   24.1.3. Market partner master data (Page 79)
*   24.2. Order Processing (Page 79)
    *   24.2.1. Determining the route for an order (Page 79)
    *   24.2.2. Shipment "via site" ("via plant") (Page 80)
    *   24.2.3. Calculation of the route date when shipping "via site" (Page 81)
    *   24.2.4. Changing the route and end route in the order (Page 81)
*   24.3. Dispatch control (Page 82)
    *   24.3.1. Via site logic / Via plant (Page 83)
    *   24.3.2. Finished products stock (Page 85)
    *   24.3.3. Complex example (Page 91)
*   24.4. Environment variables (Page 94)
...
| :--- | :--- | :--- |
| Should different legal units (companies) be mapped? | `MP_SITE_EXACT` | |
| Client-specific access rights for employees | `MP_SITE_EXACT` | Wide-ranging effects |
...
| If a master data replication is also necessary | | Can only happen on the main clients. No replication of client-specific data |
...
*   **kk**: is only evaluated for dbart!= -99
*   **hauptmandant**:
    *   `= hnr` - Main client
    *   `!= hnr AND >0` - internal client, the number is the number of the main client
...
Within the internal client separation, it is now no longer required to start the status reporting for each client individually with corresponding time delay. The status reporting is now only started for the main client. The program `trm_ctrl` regulates internally that all status bookings are processed appropriately for the individual sender and recipient.

In addition, for the status transfer between internal clients, work is no longer done via files, but directly via the corresponding transfer tables.

These two basic function adjustments mean that the time delay between booking the status in the production client and the transfer and booking in commercial client can be reduced significantly.

This adjustment means that all log messages for the status change and the status scheduling for all internal clients are only still included in the log of the calling client (main client).
...
| **IB_ALLOWIB** | **Disable**. Check!! Should no longer be required in cooperation with AWP. s.a. `IBHAUS` |
| **ALMAIL_MANDANT_BETREFF** | for system messages from internal clients. May not be set with internal client separation and configured bestelldfü. |
...
When starting the A+W Enterprise front end and also within the background processes (e.g. `intauf`), there are errors during the connect or starting of the number server (`nr_server`).
...
**Solution**: checking of the environment variables `AWC_PORT_RPC_DIENST`. This variable must be set precisely for the site and there must be an entry with `alenv.haus=0` for the main client with the values for the main clients. If the variable is not set client-specifically, the incorrect `alrpc` process of the ERPWebservice will be contacted.
...
*   Checking of CUSTOMIZING, EDI, Adhoc_SQL and Reports
    *   E.g. selos that depend on configurable fields must exist in all language environments (artcomfld.selo, mpcomfld.selo, kflddef.selo)
    *   `$ALCIBPRG/cust/...`
...
If an order is obtained from another language site for viewing, then the data on the document header level (country, packaging type, delivery type, etc.), footer (discount names), and also on the item level (article name for product and BOM element, packaging type, etc.) will be displayed in the language of the login site. If the site is not changed in the order, then the texts for the existing items will not be regenerated on loading.
...
Switching the environment is done with the script `switch_site_env` within the call `ctrlservstart`.
...
**New DB connects**
For new DB connects in customizing or in the reports, the language of the default site is always used. If another one is required, there must be a switch with `setakthnr()`.
...
| **dbart** | Identification of the master database for master data replication: `2` - Master-Master database for 2-stage replication, `1`- Master database, `0` - Client database, `-99` Sub client for self-transfer (environment variable `IBHAUS`) |
...
| **bytevekt** | `1` - Database works byte vector (`BYTE_VEKTOR=ON`), `0` - Database works with bit vector |
...
| **main site** | `=hnr` - main client. `!= hnr AND >0` internal client, the number is the number of the main client. `=0` - external client (#135188) |
...
*   If an order is entered with reference to an old order, then the company is determined again. If this is an internal market partner, then the VAT is retrieved again and there is another calculation of the gross amount.
...
If you are working with the extended internal client separation (MP_SITE_EXACT), it is essential that the CALLCENTER client is also assigned to the corresponding company.
...
For clients who order all products and do not have their own production, a special configuration with the environment variable `PMSPURCHASETRIGGER` is required. The detailed description is in the "EN-CONFIG-A+W Enterprise EDI" configuration guide. The function is also called "PMS0".
...
For more information about the configuration of the direct data import from ALCIM from PMS, see the document `\\jupiter\DOKU_DocuWare\ALCIM2000\Import\DirekterDatenimport\User Manuals\TU 030218 DirekterImport 58749.doc` (chapter "Information collection /> Internal Client Separation").

For reporting from ALCIM, heed the document `\\jupiter\DOKU_DocuWare\ALCIB-PMS\PMS-Schnittstellen\User Manuals\ALCIM Rückmeldungen im PMS.doc`.
...
Cannot run simultaneously on several sites since with each scheduling, first the working table `impdfue` is emptied and then filled per load. Thus it could happen that a table just filled is emptied right away by the next process. However, it is possible to ensure via configuration that
As a back-up, you could incorporate that scheduling may only occur on one main site => Where we would be with `xhaus.intern_md` again.
...
Losses (breakage) occurring between the two sites will be handled in the same way at losses/breakage occurring between shipping site and customer.
...
The decision to ship via another site can be made when the order is entered, or when it is amended, even if the order has already been passed on to the shipping department of the present site. The same applies for amending or deleting the shipping site.

> **Caution**: In this case, it is essential to know that such a change will lead to an immediate correction of data in the shipping department (like the cancellation of data at the original shipping site). This is why order amendments cannot be dismissed and will be rejected. The change of the change must then be made manually.
...
*   The shift menu has been completed by the fields via site and final route for this purpose. In the shipping department, changes can be made by route and order (complete orders).
...
[Image: Dispatch control screen showing a tree view of shipping dates and routes.]

#### 24.3.1. Via site logic / Via plant

Define the Via site logic by pressing `<F5>` in the order header, field Route.

[Image: Order entry screen with a popup dialog for "Auslieferung via" (Delivery via).]
...
[Image: Finished goods stock overview screen showing item positions and logs.]
...
[Image: Information screen for a specific process (Auftrag).]

2) After entering the order number, press `<F3>` or the [Release] button.

The following view appears for via site shipments:

[Image: Order information display showing items split between two sites (Haus 542 and Haus 642) with different dates and routes.]
...
[Image: Order information display showing an item split across two delivery dates due to a partial shipment.]
...
[Image: Dialog asking to create preliminary delivery notes.]
...
[Image: Order information display showing some items marked as 'under way' and others still open.]

When the goods arrive at the 'via plant' they are booked as receipts.

[Image: Menu showing the 'Liefereingang buchen' (Book goods receipt) option.]
...
[Image: Order information display showing some items as completely packed at the via plant, while one item remains open at the source plant.]
...
[Image: Order information display showing the final status after partial receipt.]
